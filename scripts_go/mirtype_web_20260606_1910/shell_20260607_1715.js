  ...
  var shellLocales = {
    ko: {
      ...
      intro: {
        ...
        summary: "MirType은 타자연습과 언어 공부를 동시에 할 수 있도록 만드는 학습형 타자연습 서비스입니다. 자리, 단어, 문장, 키보드 배열을 한 흐름 안에서 익히며 한국어, 영어, 러시아어처럼 다른 문자 체계의 입력 감각까지 함께 다룹니다.",
        ctaPractice: "바로 연습하기",
        ctaKeyboard: "키보드 보기",
        storyKicker: "Story",
        storyTitle: "MirType의 스토리",
        storySummary: "MirType이 왜 시작되었고, 어떤 학습 흐름을 만들고 있으며, 앞으로 어디로 확장하려는지 한 화면에서 확인할 수 있게 구성했습니다.",
    ...
    en: {
      ...
      intro: {
        ...
        tocPeople: "People",
        kicker: "Typing Practice + Language Learning",
        summary: "MirType is a learning typing practice service built for practicing typing and studying languages at the same time. It brings key positions, words, sentences, and keyboard layouts into one flow, including the feel of typing Korean, English, Russian, and other writing systems.",
        ctaPractice: "Start Practicing",
        ctaKeyboard: "View Keyboard",
        storyKicker: "Story",
        storyTitle: "The Story of MirType",
        storySummary: "See why MirType started, what learning flow it is building, and how it will keep expanding.",
    ...
    ru: {
      ...
      intro: {
        ...
        summary: "MirType — учебный сервис для тренировки печати и изучения языков одновременно. Он объединяет позиции клавиш, слова, предложения и раскладки клавиатуры в один поток, помогая привыкать к вводу корейского, английского, русского и других письменностей.",
        ctaPractice: "Начать тренировку",
        ctaKeyboard: "Посмотреть клавиатуру",
        storyKicker: "История",
        storyTitle: "История MirType",
        storySummary: "Здесь видно, зачем появился MirType, какой учебный поток он строит и куда будет развиваться дальше.",
