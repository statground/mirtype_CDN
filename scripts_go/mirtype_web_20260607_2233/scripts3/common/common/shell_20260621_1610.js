(function () {
  ...
  function shouldUseCourseSiblingMeaning(nativeLanguage, practiceLanguage) {
    return normalizeLanguage(nativeLanguage) === "ko" && normalizeLanguage(practiceLanguage) === "ru";
  }
  ...
  function courseItemAssist(item, options) {
    ...
    var meaning = courseItemMeaning(item, nativeLanguage) || String(entryMeanings[nativeLanguage] || "").trim();
    ...
    var pronunciation = courseItemPronunciation(item) || String((entry && (entry.ipa || entry.pronunciation)) || "").trim() || coursePhrasePronunciation(practiceLanguage, text);
    return {
      meaning: meaning,
  ...
  function renderCourseBundle(summary, courseCopy) {
    ...
    renderCourseList("[data-course-sentences]", active.day.sentences, Object.assign({}, listOptions, { nativeItems: active.nativeDay.sentences }));
  }
