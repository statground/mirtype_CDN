(function () {
  ...
  var shellLocales = {
    ko: {
      ...
      progress: {
        levelLabel: "레벨",
        levelHint: "완료한 연습 5회마다 자동으로 올라갑니다.",
        levelValue: "Lv. %d",
        streakLabel: "연속 학습",
      ...
      course: {
        ...
        changeLanguage: "연습 언어 바꾸기",
        levelPanelKicker: "Current Level",
        levelCaption: "다음 레벨까지 %d회",
        prevLevel: "이전",
        currentLevel: "현재",
        nextLevel: "다음",
    ...
    en: {
      ...
      progress: {
        levelLabel: "Level",
        levelHint: "Levels rise every 5 completed sessions.",
        levelValue: "Lv. %d",
        streakLabel: "Streak",
      ...
      course: {
        ...
        changeLanguage: "Change Practice Language",
        levelPanelKicker: "Current Level",
        levelCaption: "%d sessions to next level",
        prevLevel: "Previous",
    ...
    ru: {
      ...
      progress: {
        levelLabel: "Уровень",
        levelHint: "Уровень растет каждые 5 завершенных тренировок.",
        levelValue: "Ур. %d",
        streakLabel: "Серия",
      ...
      course: {
        ...
        changeLanguage: "Сменить язык тренировки",
        levelPanelKicker: "Current Level",
        levelCaption: "%d тренировок до следующего уровня",
        prevLevel: "Прошлый",
  ...
  function calculateLearningSummary() {
    ...
    var sessionsPerLevel = 5;
    var completedInLevel = results.length % sessionsPerLevel;
    var level = Math.max(1, Math.floor(results.length / sessionsPerLevel) + 1);
    var nextCount = sessionsPerLevel - completedInLevel;
    return {
      level: level,
      ...
      currentStep: results.length % 6,
      progressPercent: Math.min(100, Math.round((completedInLevel / sessionsPerLevel) * 100))
    };
  }
