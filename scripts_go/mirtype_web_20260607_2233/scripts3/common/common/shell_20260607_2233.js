  ...
  var shellLocales = {
    ko: {
      ...
      settings: {
        ...
        title: "언어 설정",
        summary: "화면 문구와 타자 연습 언어를 따로 선택합니다.",
        uiLanguage: "내 언어",
    ...
    en: {
      ...
      settings: {
        ...
        summary: "Choose the screen language and typing practice language separately.",
    ...
    ru: {
      ...
      settings: {
        ...
        summary: "Выберите язык интерфейса и язык тренировки отдельно.",
        uiLanguage: "Мой язык",
