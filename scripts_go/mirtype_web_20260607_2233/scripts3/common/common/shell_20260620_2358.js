(function () {
  ...
  var shellLocales = {
    ko: {
      ...
      course: {
        ...
        weekRuleBody: "한 주 동안 같은 등급의 관련 단어와 문장을 여러 방식으로 반복하고, 7일째 성취도가 충분하면 다음 난이도로 넘어갑니다.",
        ...
        dailyAdvanceHint: "오늘은 같은 묶음을 다른 방식으로 반복하며 주간 성취도를 쌓습니다.",
        dailyReviewHint: "이번 주 정확도가 아직 부족해 같은 등급을 한 번 더 복습합니다.",
        startBubble: "START",
    ...
    en: {
      ...
      course: {
        ...
        weekRuleBody: "Repeat related words and sentences in several ways for one week. On day 7, strong achievement unlocks the next difficulty.",
        mapKicker: "Bridge Map",
        ...
        dailyAdvanceHint: "Today repeats the same bundle in another form and builds weekly achievement.",
        dailyReviewHint: "This week's accuracy is not ready yet, so this level stays in review.",
        startBubble: "START",
    ...
    ru: {
      ...
      course: {
        ...
        weekRuleBody: "В течение недели связанные слова и фразы повторяются разными способами. На 7-й день хороший результат открывает следующий уровень.",
        mapKicker: "Bridge Map",
        ...
        dailyAdvanceHint: "Сегодня тот же блок повторяется в другой форме и собирает недельный результат.",
        dailyReviewHint: "Точность недели пока недостаточна, поэтому уровень остается на повторении.",
        startBubble: "START",
  ...
  function courseBundleForSummary(summary) {
    ...
    var bundles = externalBundles[language] || courseBundles[language] || courseBundles.ko;
    if (!Array.isArray(bundles) || !bundles.length) {
      bundles = courseBundles.ko;
    }
