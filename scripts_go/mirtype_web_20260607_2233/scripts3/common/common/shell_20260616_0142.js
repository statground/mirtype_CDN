(function () {
  ...
  var shellLocales = {
    ko: {
      ...
      course: {
        ...
        title: "언어 연습 코스",
        summary: "목표 언어를 읽고, 실제 키보드로 입력하고, 약한 표현을 다시 복습하는 흐름입니다.",
        unitKicker: "MIRTYPE BRIDGE 01",
        unitTitle: "징검다리를 건너며 언어 리듬을 쌓기",
        todayCta: "언어 코스 시작",
        startWord: "현재 단계 시작",
        startSentence: "문장 코스로 이어가기",
        changeLanguage: "연습 언어 바꾸기",
        levelPanelKicker: "Course Level",
        levelCaption: "다음 레벨까지 %d일",
        prevLevel: "이전",
        currentLevel: "현재",
        nextLevel: "다음",
        weekRuleTitle: "7일 연속 코스",
        weekRuleBody: "하루에 한 단계씩 건너고, 7일을 이어가면 다음 난이도로 넘어갑니다.",
        mapKicker: "Bridge Map",
        mapTitle: "레벨을 건너는 오늘의 길",
        bundleKicker: "Difficulty Bundle",
        bundleTitle: "%s · Day %d / 7",
        bundleProgress: "%d일째 · %d일 남음",
        bundleFallbackTitle: "오늘의 묶음",
        bundleSummaryFallback: "현재 난이도의 주요 단어와 문장을 연습합니다.",
        todayWordsTitle: "주요 단어",
        todaySentencesTitle: "주요 문장",
        dailyAdvanceHint: "오늘 한 단계를 끝내면 내일 다음 징검다리로 넘어갑니다.",
        startBubble: "START",
        ...
        seatNodeAria: "자리 연습",
        seatNodeLabel: "자리",
        seatNodeBody: "손가락이 키 위치와 조합 흐름을 익힙니다.",
        ...
        gameNodeAria: "타자게임",
        gameNodeLabel: "반응",
        gameNodeBody: "짧은 게임으로 읽기와 입력 반응을 깨웁니다.",
        keyboardNodeAria: "키보드 점검",
        keyboardNodeLabel: "배열",
        keyboardNodeBody: "언어별 키보드와 헷갈리는 위치를 확인합니다.",
        reviewNodeAria: "복습 큐",
        reviewNodeLabel: "복습",
      ...
      myinfo: {
        ...
        progressTitle: "학습 상태",
        recordsTitle: "내 기록",
        recordsSummary: "이 브라우저에 저장된 최근 연습 결과를 확인합니다.",
        save: "정보 저장",
        saved: "정보가 저장되었습니다.",
      ...
      home: {
        ...
        cardPracticeBody: "자리, 단어, 문장, 키보드 보기를 한 곳에서 고릅니다.",
        cardSeatTitle: "자리 연습",
      ...
      history: {
        ...
        empty: "아직 기록이 없습니다.",
        points: "점",
        modes: { seat: "자리 연습", word: "단어 연습", sentence: "문장 연습", sentenceShort: "단문 연습", sentenceLong: "장문 연습", game: "타자게임", keyboard: "키보드 보기" },
    ...
    en: {
      ...
      course: {
        ...
        summary: "Read the target language, type it with the real keyboard, and bring weak expressions back for review.",
        unitKicker: "MIRTYPE BRIDGE 01",
        unitTitle: "Cross stepping stones and build language rhythm",
        todayCta: "Start Language Course",
        startWord: "Start Current Step",
        startSentence: "Continue to Sentence Course",
        changeLanguage: "Change Practice Language",
        levelPanelKicker: "Course Level",
        levelCaption: "%d days to next level",
        prevLevel: "Previous",
        currentLevel: "Current",
        nextLevel: "Next",
        weekRuleTitle: "7-Day Course Streak",
        weekRuleBody: "Cross one step per day. Keep the streak for 7 days to unlock the next difficulty.",
        mapKicker: "Bridge Map",
        mapTitle: "Today's path across levels",
        bundleKicker: "Difficulty Bundle",
        bundleTitle: "%s · Day %d / 7",
        bundleProgress: "Day %d · %d days left",
        bundleFallbackTitle: "Today's Bundle",
        bundleSummaryFallback: "Practice the key words and sentences for the current difficulty.",
        todayWordsTitle: "Key Words",
        todaySentencesTitle: "Key Sentences",
        dailyAdvanceHint: "Finish today's step to move to the next stepping stone tomorrow.",
        startBubble: "START",
        ...
        seatNodeLabel: "Keys",
        seatNodeBody: "Let your fingers learn key positions and composition flow.",
        ...
        gameNodeLabel: "React",
        gameNodeBody: "Wake up reading and typing response with a short game.",
        keyboardNodeAria: "Keyboard Check",
        keyboardNodeLabel: "Layout",
        keyboardNodeBody: "Check target-language keys and confusing positions.",
      ...
      myinfo: {
        ...
        recordsSummary: "Review the recent practice results saved in this browser.",
        save: "Save Info",
      ...
      home: {
        ...
        cardPracticeBody: "Choose key, word, sentence, or keyboard-view practice in one place.",
      ...
      history: {
        ...
        points: "pts",
        modes: { seat: "Key Practice", word: "Word Practice", sentence: "Sentence Practice", sentenceShort: "Short Sentences", sentenceLong: "Long Passages", game: "Typing Games", keyboard: "Keyboard View" },
    ...
    ru: {
      ...
      course: {
        ...
        kicker: "Language Course",
        title: "Языковой курс",
        summary: "Читайте целевой язык, вводите его реальной клавиатурой и возвращайте слабые выражения в повторение.",
        unitKicker: "MIRTYPE BRIDGE 01",
        unitTitle: "Переходите по ступеням и собирайте языковой ритм",
        todayCta: "Начать языковой курс",
        startWord: "Начать текущий шаг",
        startSentence: "Продолжить предложениями",
        changeLanguage: "Сменить язык тренировки",
        levelPanelKicker: "Course Level",
        levelCaption: "%d дн. до следующего уровня",
        prevLevel: "Прошлый",
        currentLevel: "Текущий",
        nextLevel: "Следующий",
        weekRuleTitle: "Курс на 7 дней",
        weekRuleBody: "Каждый день открывает следующий шаг. Серия в 7 дней переводит на новую сложность.",
        mapKicker: "Bridge Map",
        mapTitle: "Сегодняшний путь по уровням",
        bundleKicker: "Difficulty Bundle",
        bundleTitle: "%s · День %d / 7",
        bundleProgress: "День %d · осталось %d дн.",
        bundleFallbackTitle: "Блок на сегодня",
        bundleSummaryFallback: "Тренируйте ключевые слова и фразы текущей сложности.",
        todayWordsTitle: "Ключевые слова",
        todaySentencesTitle: "Ключевые фразы",
        dailyAdvanceHint: "Завершите сегодняшний шаг, чтобы завтра перейти к следующему.",
        startBubble: "START",
        ...
        seatNodeBody: "Пальцы запоминают клавиши и поток ввода.",
        ...
        gameNodeBody: "Короткая игра будит чтение и скорость ответа.",
        keyboardNodeAria: "Проверка клавиатуры",
        keyboardNodeLabel: "Раскладка",
        keyboardNodeBody: "Проверьте клавиши языка и места, где легко ошибиться.",
      ...
      myinfo: {
        ...
        recordsSummary: "Посмотрите последние результаты тренировок, сохраненные в этом браузере.",
        save: "Сохранить",
      ...
      home: {
        ...
        cardPracticeBody: "Выберите клавиши, слова, предложения или клавиатуру в одном месте.",
      ...
      history: {
        ...
        points: "очк.",
        modes: { seat: "Клавиши", word: "Слова", sentence: "Предложения", sentenceShort: "Короткие фразы", sentenceLong: "Длинные тексты", game: "Игры", keyboard: "Клавиатура" },
  ...
  function isMeaningfulResult(result) {
    ...
    var knownModes = ["seat", "word", "sentence", "sentenceShort", "sentenceLong", "game", "keyboard", "자리 연습", "단어 연습", "문장 연습", "단문 연습", "장문 연습", "타자게임", "키보드 보기"];
  ...
  function calculateLearningSummary() {
    var results = readResults().filter(isMeaningfulResult);
    var streak = calculateStreak(results);
    var daysPerLevel = 7;
    var completedInLevel = streak % daysPerLevel;
    var level = Math.max(1, Math.floor(streak / daysPerLevel) + 1);
    var nextCount = daysPerLevel - completedInLevel;
    return {
      level: level,
  ...
  function courseBundleForSummary(summary) {
    var language = normalizeLanguage(currentPreferenceState().practiceLanguage);
    var bundles = courseBundles[language] || courseBundles.ko;
  ...
  function renderCourseList(selector, items) {
    qsa(selector).forEach(function (list) {
      list.replaceChildren();
      (items || []).slice(0, 7).forEach(function (text) {
  ...
  function renderCourseBundle(summary, courseCopy) {
    ...
    setText("[data-course-week-progress]", formatCopyValues(courseCopy.bundleProgress || "Day %d · %d left", [active.dayNumber, summary.nextCount]));
    ...
    setText("[data-course-daily-hint]", courseCopy.dailyAdvanceHint || "");
    renderCourseList("[data-course-words]", active.day.words);
    renderCourseList("[data-course-sentences]", active.day.sentences);
  }
  ...
  function renderLearningSummary(copy) {
    ...
    setText("[data-course-level-caption]", formatCopy(courseCopy.levelCaption || "", summary.nextCount));
  ...
  function renderHistoryRows(list, copy) {
    if (!list) {
      return;
    }
    list.replaceChildren();
    ...
    if (clear) {
      clear.addEventListener("click", function () {
        try {
          ...
          // Clearing records should never block the myinfo screen.
        }
        renderShellHistory();
        renderMyInfoRecords();
