  ...
  var shellLocales = {
    ko: {
      ...
      course: {
        ...
        signalLanguageLabel: "오늘의 신호",
        unitKicker: "MIRTYPE SIGNAL 01",
        unitTitle: "눈으로 읽고 손끝으로 보내는 첫 신호",
        todayCta: "언어 코스 시작",
        startWord: "단어 신호 열기",
        startSentence: "문장 코스로 이어가기",
        changeLanguage: "연습 언어 바꾸기",
        mapKicker: "Signal Board",
        mapTitle: "오늘 조립할 언어 신호",
        startBubble: "OPEN",
        wordNodeAria: "단어 코스 시작",
        wordNodeLabel: "감지",
        wordNodeBody: "짧은 표현을 보고 목표 언어의 첫 신호를 잡습니다.",
        seatNodeAria: "자리 연습",
        seatNodeLabel: "리듬",
        seatNodeBody: "손가락이 키 위치와 조합 흐름을 익힙니다.",
        sentenceNodeAria: "문장 코스",
        sentenceNodeLabel: "조립",
        ...
        reviewNodeAria: "복습 큐",
        reviewNodeLabel: "복습",
        reviewNodeBody: "완료 기록이 생기면 약한 신호를 다시 불러옵니다.",
    ...
    en: {
      ...
      course: {
        ...
        signalLanguageLabel: "Today's signal",
        unitKicker: "MIRTYPE SIGNAL 01",
        unitTitle: "Read with your eyes, send with your fingertips",
        todayCta: "Start Language Course",
        startWord: "Open Word Signal",
        startSentence: "Continue to Sentence Course",
        changeLanguage: "Change Practice Language",
        mapKicker: "Signal Board",
        mapTitle: "Build today's language signal",
        startBubble: "OPEN",
        wordNodeAria: "Start Word Course",
        wordNodeLabel: "Sense",
        wordNodeBody: "Catch the first signal from a short expression.",
        seatNodeAria: "Key Practice",
        seatNodeLabel: "Rhythm",
        seatNodeBody: "Let your fingers learn key positions and composition flow.",
        sentenceNodeAria: "Sentence Course",
        sentenceNodeLabel: "Assemble",
        ...
        reviewNodeBody: "When records appear, weak signals come back here.",
    ...
    ru: {
      ...
      course: {
        ...
        signalLanguageLabel: "Сигнал дня",
        unitKicker: "MIRTYPE SIGNAL 01",
        unitTitle: "Читайте глазами, отправляйте пальцами",
        todayCta: "Начать языковой курс",
        startWord: "Открыть сигнал слов",
        startSentence: "Продолжить предложениями",
        changeLanguage: "Сменить язык тренировки",
        mapKicker: "Signal Board",
        mapTitle: "Соберите языковой сигнал дня",
        startBubble: "OPEN",
        wordNodeAria: "Начать курс слов",
        wordNodeLabel: "Смысл",
        wordNodeBody: "Поймайте первый сигнал в коротком выражении.",
        seatNodeAria: "Тренировка клавиш",
        seatNodeLabel: "Ритм",
        seatNodeBody: "Пальцы запоминают клавиши и поток ввода.",
        sentenceNodeAria: "Курс предложений",
        sentenceNodeLabel: "Сборка",
        ...
        reviewNodeBody: "Когда появятся записи, слабые сигналы вернутся сюда.",
