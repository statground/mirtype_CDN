(function () {
  ...
  var shellLocales = {
    ko: {
      ...
      learning: {
        guestRecordNotice: "로그인을 하지 않아도 이용할 수 있습니다. 다만 로그인하면 실력을 기록할 수 있습니다."
      },
      account: {
        mainAria: "MirType 계정",
        inputAria: "계정 입력",
    ...
    en: {
      ...
      learning: {
        guestRecordNotice: "You can use this without logging in. If you log in, MirType can save your skill records."
      },
      account: {
    ...
    ru: {
      ...
      learning: {
        guestRecordNotice: "Можно пользоваться без входа. Если войти в аккаунт, MirType сможет сохранять ваши результаты."
      },
      account: {
