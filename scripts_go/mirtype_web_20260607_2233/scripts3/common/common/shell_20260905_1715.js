(function () {
  ...
  function courseBundlesForLanguage(language) {
    ...
    var external = sanitizeCourseBundlesForLanguage(externalBundles[key] || [], key);
    if (local.length) {
  ...
  function variedCourseDay(day, language, summary, bundle, dayIndex) {
    var source = day || {};
    ...
    var generated = generatedCourseSentences(language, words, seed + 7);
  ...
  function courseBundleForSummary(summary) {
    ...
    var variedDay = variedCourseDay(day, language, summary, bundle, dayIndex);
    var variedNativeDay = variedCourseDay(nativeDay, nativeLanguage, summary, nativeBundle, dayIndex);
    return {
  ...
  function renderCourseBundle(summary, courseCopy) {
    ...
    setText("[data-course-difficulty-title]", formatCopyValues(courseCopy.bundleTitle || "%s · Day %d / 7", [displayBundle.name || (active.bundle && active.bundle.name) || courseCopy.bundleFallbackTitle, active.dayNumber]));
