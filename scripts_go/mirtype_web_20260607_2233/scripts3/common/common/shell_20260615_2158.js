(function () {
  ...
  var shellLocales = {
    ko: {
      ...
      course: {
        ...
        sentenceNodeBody: "단어를 문장으로 연결해 의미와 입력을 맞춥니다.",
        gameNodeAria: "타자게임",
        gameNodeLabel: "반응",
    ...
    en: {
      ...
      course: {
        ...
        sentenceNodeBody: "Connect words into sentences and align meaning with input.",
    ...
    ru: {
      ...
      course: {
        ...
        sentenceNodeBody: "Соединяйте слова в предложения и связывайте смысл с вводом.",
  ...
  function isMeaningfulResult(result) {
    ...
    var knownModes = ["seat", "word", "sentence", "game", "keyboard", "자리 연습", "단어 연습", "단문 연습", "장문 연습", "타자게임", "키보드 보기"];
