(function () {
  ...
  var shellLocales = {
    ko: {
      ...
      books: {
        ...
        detailCta: "자세히 보기",
        externalCta: "서점에서 보기",
        affiliateNotice: "일부 링크는 제휴 링크이며, 구매 시 MirType 운영에 도움이 될 수 있습니다.",
        empty: "표시할 교재가 없습니다.",
    ...
    en: {
      ...
      books: {
        ...
        affiliateNotice: "Some links are affiliate links and may help support MirType operations.",
    ...
    ru: {
      ...
      books: {
        ...
        affiliateNotice: "Некоторые ссылки являются партнерскими и могут поддерживать работу MirType.",
  ...
  function localizeBooksMeta(copy) {
    if (!qs(".books-page") || qs(".book-detail")) {
      return;
    }
