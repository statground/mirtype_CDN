  ...
  function buildContent() {
    ...
    return {
      ko: {
        ...
        words: unique(koWords.concat(studyWords.ko).concat(studyTopicWords.ko)),
      ...
      en: {
        ...
        words: unique(enWords.concat(studyWords.en).concat(studyTopicWords.en)),
      ...
      ru: {
        ...
        words: unique(ruWords.concat(studyWords.ru).concat(studyTopicWords.ru)),
