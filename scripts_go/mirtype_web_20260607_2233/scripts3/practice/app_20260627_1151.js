(function () {
  ...
  function setPracticeLanguage(value, persist) {
    ...
    if (!state.keyboardLanguageCustomized) {
  ...
  function courseStageMeta(offset) {
    ...
    return {
      ...
      summary: summary,
      active: active,
      label: (active.bundle && active.bundle.name ? active.bundle.name : "Level " + summary.level),
      day: active.dayNumber || ((summary.currentStep || 0) + 1),
      title: (active.day && active.day.title) || "",
      summaryText: (active.day && active.day.summary) || ""
    };
  }
