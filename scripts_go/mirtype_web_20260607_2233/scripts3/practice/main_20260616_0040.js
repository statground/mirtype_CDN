  ...
  function buildContent() {
    ...
    return {
      ko: {
        ...
        words: unique(koWords.concat(studyWords.ko)),
        shorts: unique(studyShorts.ko.concat(makeKoreanShorts())),
        longs: unique(studyLongs.ko.concat(makeKoreanLongs()))
      },
      en: {
        label: "English",
        seat: {
        ...
        words: unique(enWords.concat(studyWords.en)),
        shorts: unique(studyShorts.en.concat(makeEnglishShorts())),
        longs: unique(studyLongs.en.concat(makeEnglishLongs()))
      },
      ru: {
        label: "Русский",
        seat: {
        ...
        words: unique(ruWords.concat(studyWords.ru)),
        shorts: unique(studyShorts.ru.concat(makeRussianShorts())),
        longs: unique(studyLongs.ru.concat(makeRussianLongs()))
      }
    };
  }
