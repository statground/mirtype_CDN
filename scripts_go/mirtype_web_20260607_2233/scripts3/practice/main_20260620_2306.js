(function () {
  ...
  function russianWorkbookWords() {
    var workbook = window.MirtypeRussianWorkbook || {};
    return {
      ko: Array.isArray(workbook.koreanMeanings) ? workbook.koreanMeanings : [],
      en: Array.isArray(workbook.englishWords) ? workbook.englishWords : [],
      ru: Array.isArray(workbook.russianWords) ? workbook.russianWords : []
    };
  }
