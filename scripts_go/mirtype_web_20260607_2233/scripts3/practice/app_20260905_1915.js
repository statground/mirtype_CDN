(function () {
  ...
  var locales = {
    ko: {
      ...
      courseMapTitle: "언어 코스 단계",
      courseMapSummary: "이전 단계, 현재 단계, 다음 단계를 확인한 뒤 연습을 이어갑니다.",
      courseMapContinue: "연습 이어가기",
      courseMapPrevious: "이전 단계",
      courseMapNext: "다음 단계",
      courseMapCurrent: "현재",
      courseMapPreviousLabel: "이전",
      courseMapNextLabel: "다음",
      courseMapDay: "일차",
      courseMeaningLabel: "뜻",
      coursePronunciationLabel: "발음",
      coursePronunciationIpaLabel: "IPA",
      coursePronunciationRomanLabel: "Latin",
      coursePronunciationNativeLabel: "한국어식",
      courseNoAssist: "뜻과 발음 보조가 준비되면 여기에 표시됩니다.",
      courseCompleteTitle: "오늘 코스 완료",
      courseCompleteHint: "한 항목씩 정확히 입력했습니다. 다음 연습으로 이어가도 좋습니다.",
      completionNextPractice: "다음 연습 시작",
      completionNextCourse: "다음 단계 시작",
      completionCourseMap: "코스 맵 보기",
      ...
      gameDifficultyLabel: "난이도",
      gameDifficultyValue: "난이도 %s",
      gameDifficultyHint: "0은 자리 연습, 10은 긴 단어 중심",
      gameDescriptions: {
    ...
    en: {
      ...
      modes: {
        ...
        sentenceShort: "Short Sentences",
        sentenceLong: "Long Passages",
        game: "Typing Games",
        keyboard: "Keyboard Test"
      },
      languageNames: { ko: "Korean", en: "English", ru: "Russian" },
      courseStepLabel: "Step",
      courseInputLabel: "Input",
      courseKindLabel: "Type",
      courseRemainingLabel: "Left",
      courseReady: "Typing",
      courseMatched: "Checked",
      courseComplete: "Done",
      courseKindWord: "Word",
      courseKindShort: "Sentence",
      courseKindLong: "Long",
      courseMapKicker: "Course Map",
      courseMapTitle: "Language Course Path",
      courseMapSummary: "Check the previous, current, and next stages before continuing practice.",
      courseMapContinue: "Continue Practice",
      courseMapPrevious: "Previous Stage",
      courseMapNext: "Next Stage",
      courseMapCurrent: "Current",
      courseMapPreviousLabel: "Previous",
      courseMapNextLabel: "Next",
      courseMapDay: "Day",
      courseMeaningLabel: "Meaning",
      coursePronunciationLabel: "Pronunciation",
      coursePronunciationIpaLabel: "IPA",
      coursePronunciationRomanLabel: "Latin",
      coursePronunciationNativeLabel: "English guide",
      courseNoAssist: "Meaning and pronunciation clues will appear here when available.",
      courseCompleteTitle: "Today's Course Complete",
      courseCompleteHint: "You typed each item accurately. You can move into the next practice.",
      completionNextPractice: "Start Next Practice",
      completionNextCourse: "Start Next Stage",
      completionCourseMap: "View Course Map",
      ...
      gameDifficultyValue: "Difficulty %s",
      gameDifficultyHint: "0 is key practice, 10 favors long words",
      gameDescriptions: {
    ...
    ru: {
      ...
      modes: {
        ...
        sentenceShort: "Короткие фразы",
        sentenceLong: "Длинные тексты",
        game: "Игры",
        keyboard: "Проверка клавиатуры"
      },
      languageNames: { ko: "Корейский", en: "Английский", ru: "Русский" },
      courseStepLabel: "Шаг",
      courseInputLabel: "Ввод",
      courseKindLabel: "Тип",
      courseRemainingLabel: "Осталось",
      courseReady: "Печать",
      courseMatched: "Проверено",
      courseComplete: "Готово",
      courseKindWord: "Слово",
      courseKindShort: "Фраза",
      courseKindLong: "Текст",
      courseMapKicker: "Карта курса",
      courseMapTitle: "Путь языкового курса",
      courseMapSummary: "Посмотрите предыдущий, текущий и следующий этапы, затем продолжите тренировку.",
      courseMapContinue: "Продолжить",
      courseMapPrevious: "Предыдущий этап",
      courseMapNext: "Следующий этап",
      courseMapCurrent: "Текущий",
      courseMapPreviousLabel: "Предыдущий",
      courseMapNextLabel: "Следующий",
      courseMapDay: "День",
      courseMeaningLabel: "Значение",
      coursePronunciationLabel: "Произношение",
      coursePronunciationIpaLabel: "IPA",
      coursePronunciationRomanLabel: "Latin",
      coursePronunciationNativeLabel: "На моём языке",
      courseNoAssist: "Подсказки значения и произношения появятся здесь, когда они доступны.",
      courseCompleteTitle: "Курс на сегодня завершен",
      courseCompleteHint: "Вы точно напечатали каждый элемент. Можно переходить к следующей тренировке.",
      completionNextPractice: "Начать следующую тренировку",
      completionNextCourse: "Начать следующий этап",
      completionCourseMap: "Открыть карту курса",
      ...
      gameDifficultyLabel: "Сложность",
      gameDifficultyValue: "Сложность %s",
      gameDifficultyHint: "0 - клавиши, 10 - длинные слова",
      gameDescriptions: {
      ...
      keyboardLanguageLabel: "Язык клавиатуры",
  ...
  var modePaths = {
    ...
    seat: "/practice/seat/",
    word: "/practice/word/",
    sentenceShort: "/practice/sentence/short/",
    sentenceLong: "/practice/sentence/long/",
    game: "/practice/game/",
    keyboard: "/keyboard/"
  };
  var gamePaths = {
    rain: "/practice/game/rain/",
    invader: "/practice/game/invader/",
    mining: "/practice/game/mining/"
  };
  ...
  var state = {
    ...
    practiceLanguage: "ko",
    keyboardLanguage: "ko",
    keyboardLanguageCustomized: false,
  ...
  function init() {
    ...
    elements.gameDifficultyControls = Array.from(document.querySelectorAll("[data-game-difficulty-control]"));
    elements.gameDifficultyInputs = Array.from(document.querySelectorAll("[data-game-difficulty]"));
    elements.gameDifficultyValues = Array.from(document.querySelectorAll("[data-game-difficulty-value]"));
    elements.gameDifficultyLabels = Array.from(document.querySelectorAll("[data-game-difficulty-label]"));
    elements.gameDifficultyHints = Array.from(document.querySelectorAll("[data-game-difficulty-hint]"));
    ...
    elements.resultGrid = elements.resultPanel ? elements.resultPanel.querySelector(".result-grid") : null;
    ...
    elements.keyboardLanguagePanel = document.querySelector("[data-keyboard-language-panel]");
  ...
  function modeFromPath(path) {
    ...
    if (normalized === "/practice/sentence/" || normalized === "/sentence/") {
      return "sentenceShort";
    }
    if (normalized === "/game/" || normalized === "/practice/game/" || gameFromPath(normalized)) {
      return "game";
    }
    if (normalized === "/seat/") {
      return "seat";
    ...
    if (normalized === "/keyboard/" || normalized === "/practice/keyboard/") {
      return "keyboard";
    }
  ...
  function gameFromPath(path) {
    var normalized = path || "";
    if (normalized === "/game/rain/") {
      return "rain";
    }
    if (normalized === "/game/invader/") {
      return "invader";
    }
    if (normalized === "/game/mining/") {
      return "mining";
    }
  ...
  function syncKeyboardToPracticeLanguage() {
    state.keyboardLanguage = state.practiceLanguage;
    state.keyboardLanguageCustomized = false;
    syncActiveButton("[data-keyboard-language]", state.keyboardLanguage);
  }
  ...
  function setMode(mode, updateURL, options) {
    ...
    if (state.mode === "course") {
      state.course.introVisible = true;
      state.course.selectedOffset = 0;
    }
    if (state.mode !== "keyboard") {
      syncKeyboardToPracticeLanguage();
      renderKeyboard();
    }
  ...
  function bindButtons() {
    ...
    document.querySelectorAll("[data-keyboard-language]").forEach(function (button) {
      button.addEventListener("click", function () {
        setKeyboardLanguage(button.dataset.keyboardLanguage);
      });
    });
    ...
    elements.gameDifficultyInputs.forEach(function (input) {
      input.addEventListener("input", function () {
        setGameDifficulty(input.value, true);
      });
    ...
    window.addEventListener("mirtype:languagechange", handleShellLanguageChange);
    window.addEventListener("mirtype:coursecontentready", function () {
      if (state.mode !== "course") {
        return;
      }
      resetPractice();
      refreshShellProgress();
    });
  }
  ...
  function syncActiveButton(selector, value) {
    document.querySelectorAll(selector).forEach(function (button) {
      var buttonValue = button.dataset.mode || button.dataset.uiLanguage || button.dataset.practiceLanguage || button.dataset.keyboardLanguage || button.dataset.language || button.dataset.lesson || button.dataset.duration || button.dataset.game;
  ...
  function setPracticeLanguage(value, persist) {
    ...
    if (state.mode !== "keyboard" || !state.keyboardLanguageCustomized) {
      syncKeyboardToPracticeLanguage();
    }
    if (state.mode === "course") {
      state.course.introVisible = true;
  ...
  function setKeyboardLanguage(value) {
    var next = normalizeLanguage(value, state.keyboardLanguage || state.practiceLanguage);
    if (state.keyboardLanguage === next) {
      state.keyboardLanguageCustomized = true;
      syncLanguageButtons();
      elements.input.focus();
      return;
    }
    state.keyboardLanguage = next;
    state.keyboardLanguageCustomized = true;
    syncLanguageButtons();
    renderKeyboard();
    refreshRuntimeCopy();
  ...
  function loadPreferences() {
    ...
    state.keyboardLanguage = fallback;
    state.keyboardLanguageCustomized = false;
    try {
      var raw = window.localStorage.getItem(PREFERENCES_KEY);
      if (!raw) {
        var shellPreferences = readShellPreferences();
        if (shellPreferences) {
          state.uiLanguage = normalizeLanguage(shellPreferences.uiLanguage || shellPreferences.nativeLanguage, fallback);
          state.practiceLanguage = normalizeLanguage(shellPreferences.practiceLanguage || shellPreferences.targetLanguage || shellPreferences.language, state.uiLanguage);
          state.keyboardLanguage = state.practiceLanguage;
          state.gameDifficulty = clampGameDifficulty(shellPreferences.gameDifficulty);
          state.preferencesSaved = true;
        }
      ...
      state.uiLanguage = normalizeLanguage(parsed.uiLanguage || parsed.nativeLanguage, fallback);
      state.practiceLanguage = normalizeLanguage(parsed.practiceLanguage || parsed.targetLanguage || parsed.language, state.uiLanguage);
      state.keyboardLanguage = state.practiceLanguage;
      state.gameDifficulty = clampGameDifficulty(parsed.gameDifficulty);
      state.preferencesSaved = true;
    } catch (error) {
      state.uiLanguage = fallback;
      state.practiceLanguage = fallback;
  ...
  function readShellPreferences() {
    if (!window.MirtypeLearningStore || typeof window.MirtypeLearningStore.readPreferences !== "function") {
      return null;
    }
    try {
      var preference = window.MirtypeLearningStore.readPreferences();
      if (preference && (preference.uiLanguage || preference.nativeLanguage || preference.practiceLanguage || preference.language)) {
        return preference;
      }
    } catch (error) {
      return null;
  ...
  function preferencePayload(updatedAt) {
    return {
  ...
  function writePreferenceCache(updatedAt) {
    try {
      window.localStorage.setItem(PREFERENCES_KEY, JSON.stringify(preferencePayload(updatedAt)));
    } catch (error) {
      // Browser cache errors should not block ClickHouse-backed preference saving.
    }
  }

  function savePreferences() {
    var payload = preferencePayload();
    if (window.MirtypeLearningStore && typeof window.MirtypeLearningStore.savePreferences === "function") {
      window.MirtypeLearningStore.savePreferences(payload);
    }
    writePreferenceCache(payload.updatedAt);
  }

  function requestRemotePreferences() {
    if (!window.MirtypeLearningStore || typeof window.MirtypeLearningStore.requestPreferences !== "function") {
      return;
    }
    window.MirtypeLearningStore.requestPreferences().then(function (preference) {
      if (!preference || !preference.ready) {
        return;
      }
      state.uiLanguage = normalizeLanguage(preference.uiLanguage || preference.nativeLanguage, state.uiLanguage);
      state.practiceLanguage = normalizeLanguage(preference.practiceLanguage, state.practiceLanguage);
      if (state.mode !== "keyboard" || !state.keyboardLanguageCustomized) {
        syncKeyboardToPracticeLanguage();
      }
      state.gameDifficulty = clampGameDifficulty(preference.gameDifficulty);
      writePreferenceCache(preference.updatedAt);
      syncLanguageButtons();
      applyLocale();
      renderKeyboard();
  ...
  function handleShellLanguageChange(event) {
    var detail = (event && event.detail) || {};
    var shellPreferences = readShellPreferences() || {};
    var nextUiLanguage = normalizeLanguage(detail.uiLanguage || detail.nativeLanguage || shellPreferences.uiLanguage || shellPreferences.nativeLanguage, state.uiLanguage);
    var practiceSource = detail.practiceLanguage || detail.targetLanguage || shellPreferences.practiceLanguage || shellPreferences.targetLanguage || shellPreferences.language || "";
    var nextPracticeLanguage = practiceSource ? normalizeLanguage(practiceSource, state.practiceLanguage) : state.practiceLanguage;
    var changed = false;
    if (state.uiLanguage !== nextUiLanguage) {
      state.uiLanguage = nextUiLanguage;
      changed = true;
    }
    if (state.practiceLanguage !== nextPracticeLanguage) {
      state.practiceLanguage = nextPracticeLanguage;
      changed = true;
    }
    if (!changed) {
      return;
    ...
    if (state.mode !== "keyboard") {
      syncKeyboardToPracticeLanguage();
    } else if (!state.keyboardLanguageCustomized) {
      state.keyboardLanguage = state.practiceLanguage;
    }
    if (state.mode === "course") {
      state.course.introVisible = true;
  ...
  function requestRemoteLearningState() {
    if (window.MirtypeLearningStore && typeof window.MirtypeLearningStore.requestState === "function") {
      window.MirtypeLearningStore.requestState({
        uiLanguage: state.uiLanguage,
        practiceLanguage: activePracticeLanguageKey(),
        activityKey: currentActivityKey(),
        activityDetailKey: currentActivityDetailKey()
      }).then(function () {
        renderHistory();
        refreshShellProgress();
      });
  ...
  function keyboardLanguageKey() {
    var key = state.mode === "keyboard" ? state.keyboardLanguage : state.practiceLanguage;
    return data[key] ? key : "ko";
  }

  function activePracticeLanguageKey() {
    return state.mode === "keyboard" ? keyboardLanguageKey() : practiceLanguageKey();
  }

  function languagePairKey(uiLanguage, practiceLanguage) {
    return normalizeLanguage(uiLanguage, "ko") + "->" + normalizeLanguage(practiceLanguage, "ko");
  }

  function currentLanguagePairKey() {
    return languagePairKey(state.uiLanguage, activePracticeLanguageKey());
  }
  ...
  function currentActivityKey() {
    return activityKeyFor(state.mode, state.game);
  }

  function currentActivityDetailKey() {
    var mode = normalizeResultMode(state.mode);
    if (mode === "course") {
      return "course";
    }
    if (mode === "game") {
      return "game:" + String(state.game || "default");
    }
  ...
  function refreshShellProgress() {
    var runtime = courseRuntime();
    if (typeof runtime.refreshLearningSummary === "function") {
      runtime.refreshLearningSummary();
    }
  }
  ...
  function applyLocale() {
    ...
    document.querySelectorAll("[data-keyboard-language-panel]").forEach(function (node) {
      node.setAttribute("aria-label", copy.aria.keyboardLanguage);
    });
    if (elements.settingsPopover) {
    ...
    if (state.finished && state.mode === "course") {
      elements.resultTitle.textContent = copy.courseCompleteTitle || copy.resultTitle;
      renderCompletionHint(copy.courseCompleteHint || "");
    }
    setText("[data-ui-language-label]", copy.uiLanguageLabel);
    setText("[data-practice-language-label]", copy.practiceLanguageLabel);
    setText("[data-keyboard-language-label]", copy.keyboardLanguageLabel);
    ...
    if (state.mode === "course") {
      renderCourseAssist(state.finished);
      updateStats(getCourseMetrics(currentTypedValue()));
    }
    applyKeyboardVisibility();
    renderHistory();
  ...
  function clampGameDifficulty(value) {
  ...
  function setGameDifficulty(value, persist) {
    state.gameDifficulty = clampGameDifficulty(value);
    updateGameDifficultyUI();
    if (persist) {
      savePreferences();
    }
    if (state.mode === "game" && state.game && !state.finished) {
      resetPractice();
    }
  }

  function updateGameDifficultyUI(copy) {
    copy = copy || locale();
    var value = String(state.gameDifficulty);
    var valueText = (copy.gameDifficultyValue || "Difficulty %s").replace("%s", value);
    elements.gameDifficultyInputs.forEach(function (input) {
      input.value = value;
      input.setAttribute("aria-valuetext", valueText);
    });
    elements.gameDifficultyValues.forEach(function (node) {
      node.textContent = valueText;
    });
    elements.gameDifficultyLabels.forEach(function (node) {
      node.textContent = copy.gameDifficultyLabel || "Difficulty";
    });
    elements.gameDifficultyHints.forEach(function (node) {
      node.textContent = copy.gameDifficultyHint || "";
    });
    elements.gameDifficultyControls.forEach(function (node) {
      node.setAttribute("aria-label", valueText);
      node.hidden = state.mode !== "game";
    });
  }
  ...
  function ensureCourseMapPanel() {
    if (elements.courseMapPanel) {
      return elements.courseMapPanel;
    }
    var panel = document.createElement("section");
    panel.className = "course-map-panel";
    panel.setAttribute("aria-live", "polite");
    if (elements.statsGrid && elements.statsGrid.parentNode) {
      elements.statsGrid.parentNode.insertBefore(panel, elements.statsGrid);
    } else if (elements.practiceSurface && elements.practiceSurface.parentNode) {
      elements.practiceSurface.parentNode.insertBefore(panel, elements.practiceSurface);
    }
    elements.courseMapPanel = panel;
    return panel;
  }

  function hideCourseMap() {
    if (elements.courseMapPanel) {
      elements.courseMapPanel.hidden = true;
    }
    hideCourseSkeleton();
  }

  function hideCourseSkeleton() {
    var shell = document.querySelector(".app-shell.is-course-view");
    if (shell) {
      shell.removeAttribute("data-course-shell-loading");
    }
    document.querySelectorAll("[data-course-skeleton]").forEach(function (node) {
      node.hidden = true;
    });
  }

  function courseBaseAbsoluteStep() {
    return courseAbsoluteStep(courseSummary(), 0);
  }

  function setCourseSelectedAbsolute(absolute) {
    state.course.selectedOffset = absolute - courseBaseAbsoluteStep();
  }

  function shiftCourseStage(delta) {
    var max = courseMaxAbsoluteStep();
    var current = courseAbsoluteStep(courseSummary(), state.course.selectedOffset);
    setCourseSelectedAbsolute(Math.min(max, Math.max(0, current + delta)));
    resetPractice();
  }

  function startCoursePractice() {
    state.course.introVisible = false;
    syncKeyboardToPracticeLanguage();
    renderKeyboard();
    resetPractice();
  }

  function courseStageBadge(copy, offset) {
    if (offset === 0) {
      return copy.courseMapCurrent || "Current";
    }
    if (offset < 0) {
      return copy.courseMapPreviousLabel || "Previous";
    }
    return copy.courseMapNextLabel || "Next";
  }

  function renderCourseMap() {
    var copy = locale();
    var panel = ensureCourseMapPanel();
    hideCourseSkeleton();
    var max = courseMaxAbsoluteStep();
    var selectedAbsolute = courseAbsoluteStep(courseSummary(), state.course.selectedOffset);
    var start = Math.max(0, Math.min(selectedAbsolute - 2, max - 4));
    var end = Math.min(max, start + 4);
    panel.hidden = false;
    panel.replaceChildren();

    var head = document.createElement("div");
    head.className = "course-map-head";
    var kicker = document.createElement("p");
    kicker.className = "surface-kicker";
    kicker.textContent = copy.courseMapKicker || "Course Map";
    var title = document.createElement("h2");
    title.textContent = copy.courseMapTitle || "Language Course Path";
    var summary = document.createElement("p");
    summary.textContent = copy.courseMapSummary || "";
    head.appendChild(kicker);
    head.appendChild(title);
    head.appendChild(summary);

    var path = document.createElement("div");
    path.className = "course-stage-path";
    for (var absolute = start; absolute <= end; absolute += 1) {
      var offset = absolute - courseBaseAbsoluteStep();
      var meta = courseStageMeta(offset);
      var node = document.createElement("button");
      node.className = "course-stage-node";
      node.type = "button";
      node.dataset.courseStageAbsolute = String(absolute);
      node.classList.toggle("is-current", offset === 0);
      node.classList.toggle("is-selected", absolute === selectedAbsolute);
      var badge = document.createElement("span");
      badge.className = "course-stage-badge";
      badge.textContent = courseStageBadge(copy, offset);
      var dot = document.createElement("span");
      dot.className = "course-stage-dot";
      var label = document.createElement("strong");
      label.textContent = meta.label;
      var day = document.createElement("span");
      day.textContent = (copy.courseMapDay || "Day") + " " + meta.day;
      node.appendChild(badge);
      node.appendChild(dot);
      node.appendChild(label);
      node.appendChild(day);
      node.addEventListener("click", function () {
        setCourseSelectedAbsolute(parseInt(this.dataset.courseStageAbsolute || "0", 10));
        resetPractice();
      });
      path.appendChild(node);
    }

    var selected = courseStageMeta(state.course.selectedOffset);
    var detail = document.createElement("div");
    detail.className = "course-map-detail";
    var detailTitle = document.createElement("strong");
    detailTitle.textContent = selected.title || selected.label;
    var detailSummary = document.createElement("span");
    detailSummary.textContent = selected.summaryText || selected.label + " · " + (copy.courseMapDay || "Day") + " " + selected.day;
    detail.appendChild(detailTitle);
    detail.appendChild(detailSummary);

    var actions = document.createElement("div");
    actions.className = "course-map-actions";
    var previous = document.createElement("button");
    previous.type = "button";
    previous.className = "site-menu-action";
    previous.textContent = copy.courseMapPrevious || "Previous Stage";
    previous.disabled = selectedAbsolute <= 0;
    previous.addEventListener("click", function () { shiftCourseStage(-1); });
    var continueButton = document.createElement("button");
    continueButton.type = "button";
    continueButton.className = "site-menu-action is-active";
    continueButton.textContent = copy.courseMapContinue || "Continue Practice";
    continueButton.addEventListener("click", startCoursePractice);
    var next = document.createElement("button");
    next.type = "button";
    next.className = "site-menu-action";
    next.textContent = copy.courseMapNext || "Next Stage";
    next.disabled = selectedAbsolute >= max;
    next.addEventListener("click", function () { shiftCourseStage(1); });
  ...
  function setCourseIntroVisible(visible) {
    if (state.mode !== "course") {
      hideCourseMap();
      return;
    }
    if (visible) {
      ...
      if (elements.practiceSurface) {
        elements.practiceSurface.hidden = true;
      }
      if (elements.keyboardPanel) {
    ...
    if (elements.practiceSurface) {
      elements.practiceSurface.hidden = false;
    }
  ...
  function resetPractice() {
    ...
    if (state.course.advanceTimer) {
      window.clearTimeout(state.course.advanceTimer);
      state.course.advanceTimer = 0;
    }
    ...
    elements.prompt.classList.toggle("is-long", state.mode === "sentenceLong");
    ...
    if (elements.keyboardLanguagePanel) {
      elements.keyboardLanguagePanel.hidden = state.mode !== "keyboard";
    }
    updateGameDifficultyUI(copy);
    applyFontScale();
    applyKeyboardVisibility();
    ...
    if (state.mode === "course") {
      state.target = buildCourseTarget();
      if (state.course.introVisible) {
        elements.prompt.replaceChildren();
        elements.gameStage.replaceChildren();
        elements.progress.style.width = "0%";
        updateStats(getCourseMetrics(""));
        setCourseIntroVisible(true);
        return;
      }
      setCourseIntroVisible(false);
      renderPrompt("");
      renderCourseAssist();
      updateStats(getCourseMetrics(""));
      updateNextPreview("");
  ...
  function gameSeatPool() {
    var languageData = practiceData();
    var seat = languageData.seat || {};
    var units = [];
    ["home", "top", "bottom", "number", "mixed"].forEach(function (key) {
      units = units.concat(seat[key] || []);
    });
    return unique(units.map(function (unit) {
      return String(unit || "").trim();
    }).filter(Boolean));
  }

  function gameWordScore(word) {
    var text = String(word || "").trim();
    var length = Array.from(text.replace(/\s+/g, "")).length;
  ...
  function gameWordPool() {
    var difficulty = clampGameDifficulty(state.gameDifficulty);
    if (difficulty <= 0) {
      return gameSeatPool();
    }
    var words = unique((practiceData().words || []).map(function (word) {
      return String(word || "").trim();
    }).filter(Boolean));
    var sorted = words.slice().sort(function (left, right) {
      return gameWordScore(left) - gameWordScore(right);
    });
    var filtered = sorted.filter(function (word) {
      var score = gameWordScore(word);
      if (difficulty <= 3) {
        return score <= 3 + difficulty;
      }
      if (difficulty <= 7) {
        return score >= Math.max(2, difficulty - 2) && score <= difficulty + 4;
      }
      return score >= Math.max(5, difficulty - 2);
    });
    return filtered.length >= 8 ? filtered : sorted;
  }

  function gameSample(count) {
    return sample(gameWordPool(), count).filter(Boolean);
  }
  ...
  function getKeyboardTitle() {
    var copy = locale();
    var key = keyboardLanguageKey();
    if (state.uiLanguage === key && copy.keyboardName) {
      return copy.keyboardName;
    }
    return languageLabel(key) + " " + copy.keyboardSuffix;
  }
  ...
  function buildTarget() {
    ...
    if (state.mode === "course") {
      return buildCourseTarget();
    }
    if (state.mode === "word") {
      state.units = sample(practiceData().words, 36);
      return state.units.join(" ");
    }
    if (state.mode === "sentence" || state.mode === "sentenceShort" || state.mode === "sentenceLong") {
  ...
  function buildSentenceTarget() {
    var languageData = practiceData();
    if (state.mode === "sentenceLong") {
      state.units = sample(languageData.longs, 1);
      return state.units[0] || "";
    }
    state.units = sample(languageData.shorts, 1);
    return state.units[0] || "";
  }

  function courseRuntime() {
    return window.MirtypeCourseRuntime && typeof window.MirtypeCourseRuntime === "object" ? window.MirtypeCourseRuntime : {};
  }

  function courseSummary() {
    var runtime = courseRuntime();
    if (typeof runtime.calculateLearningSummary === "function") {
      return runtime.calculateLearningSummary({
        pairKey: currentLanguagePairKey(),
        activityKey: "course"
      });
    }
    return { level: 1, currentStep: 0, progressPercent: 0, achievementPercent: 0 };
  }

  function courseMaxAbsoluteStep() {
    var runtime = courseRuntime();
    var bundles = [];
    if (typeof runtime.bundlesForLanguage === "function") {
      bundles = runtime.bundlesForLanguage(practiceLanguageKey()) || [];
    } else {
      bundles = externalCourseBundlesForLanguage(practiceLanguageKey());
    }
    var total = 0;
    (bundles || []).forEach(function (bundle) {
      total += Math.max((bundle.days || []).length, 0);
    });
    return Math.max(0, total - 1);
  }

  function courseAbsoluteStep(summary, offset) {
    var days = Math.max(summary.daysPerLevel || 7, 1);
    var base = Math.max(0, ((summary.level || 1) - 1) * days + (summary.currentStep || 0));
    return Math.min(courseMaxAbsoluteStep(), Math.max(0, base + (offset || 0)));
  }

  function courseSummaryForOffset(offset) {
    var base = courseSummary();
    var days = Math.max(base.daysPerLevel || 7, 1);
    var absolute = courseAbsoluteStep(base, offset || 0);
    return Object.assign({}, base, {
      absoluteStep: absolute,
      level: Math.floor(absolute / days) + 1,
      currentStep: absolute % days,
      progressPercent: Math.min(100, Math.round(((absolute % days) / days) * 100))
    });
  }

  function activeCourseDay(offset) {
    var runtime = courseRuntime();
    var selectedOffset = offset === undefined ? (state.course.selectedOffset || 0) : offset;
    var summary = courseSummaryForOffset(selectedOffset);
    if (typeof runtime.bundleForSummary === "function") {
      return runtime.bundleForSummary(summary);
    }
    var language = practiceLanguageKey();
    var languageBundles = externalCourseBundlesForLanguage(language);
    var nativeBundles = externalCourseBundlesForLanguage(state.uiLanguage);
    var bundle = (languageBundles[0]) || {};
    var nativeBundle = (nativeBundles[0]) || {};
    return {
      bundle: bundle,
      day: (bundle.days || [])[0] || {},
      nativeBundle: nativeBundle,
      nativeDay: (nativeBundle.days || [])[0] || {},
      dayNumber: 1,
      language: language,
      nativeLanguage: state.uiLanguage
    };
  ...
  function externalCourseBundlesForLanguage(language) {
    var bundles = window.MirtypeCourseBundles || {};
    var key = normalizeLanguage(language, "ko");
    return (bundles[key] || []).filter(function (bundle) {
      return courseBundleMatchesLanguage(bundle, key);
    });
  }

  function courseBundleMatchesLanguage(bundle, language) {
    var target = courseBundleTargetLanguage(bundle);
    return !target || target === normalizeLanguage(language, "ko");
  }

  function courseBundleTargetLanguage(bundle) {
    var labels = [];
    if (bundle) {
      labels.push(bundle.name || "");
      (bundle.days || []).slice(0, 3).forEach(function (day) {
        labels.push(day && day.title || "");
      });
    }
    var text = labels.join(" ").toLowerCase();
    if (!text) {
      return "";
    }
    var targets = [];
    if (text.indexOf("한국어") >= 0 || text.indexOf("korean") >= 0 || text.indexOf("корей") >= 0) {
      targets.push("ko");
    }
    if (text.indexOf("영어") >= 0 || text.indexOf("english") >= 0 || text.indexOf("англий") >= 0) {
      targets.push("en");
    }
    if (text.indexOf("러시아어") >= 0 || text.indexOf("russian") >= 0 || text.indexOf("русск") >= 0) {
      targets.push("ru");
    }
    return targets.length === 1 ? targets[0] : "";
  }

  function courseDisplayBundle(active) {
    if (active && active.nativeBundle && active.nativeBundle.name) {
      return active.nativeBundle;
    }
    return (active && active.bundle) || {};
  }

  function courseDisplayDay(active) {
    if (active && active.nativeDay && (active.nativeDay.title || active.nativeDay.summary)) {
      return active.nativeDay;
    }
    return (active && active.day) || {};
  }

  function courseStageMeta(offset) {
    var active = activeCourseDay(offset);
    var summary = courseSummaryForOffset(offset);
    var displayBundle = courseDisplayBundle(active);
    var displayDay = courseDisplayDay(active);
    return {
      offset: offset,
      summary: summary,
      active: active,
      label: (displayBundle.name || (active.bundle && active.bundle.name) || "Level " + summary.level),
      day: active.dayNumber || ((summary.currentStep || 0) + 1),
      title: displayDay.title || "",
      summaryText: displayDay.summary || ""
    };
  }

  function courseItemText(item) {
    var runtime = courseRuntime();
    if (typeof runtime.itemText === "function") {
      return runtime.itemText(item);
    }
  ...
  function courseLettersFromWords(words) {
    var runtime = courseRuntime();
    if (typeof runtime.lettersFromItems === "function") {
      return runtime.lettersFromItems(words);
    }
    var letters = [];
    var seen = {};
  ...
  function courseItemAssist(item, index, nativeItems, active) {
    var runtime = courseRuntime();
    if (typeof runtime.itemAssist === "function") {
      return runtime.itemAssist(item, {
  ...
  function courseSentenceKind(item, language) {
    var text = courseItemText(item);
    var characters = Array.from(text).length;
    var words = text ? text.split(/\s+/).length : 0;
    if (language === "ko") {
      return characters >= 320 && words >= 80 ? "long" : "short";
    }
    if (language === "en" || language === "ru") {
      return characters >= 650 && words >= 90 ? "long" : "short";
    }
    return "short";
  }

  function makeCourseItem(kind, item, index, nativeItems, active) {
    var text = courseItemText(item);
    if (!text) {
      return null;
    }
    var assist = courseItemAssist(item, index, nativeItems, active);
    return {
      kind: kind === "short" ? courseSentenceKind(item, active.language) : kind,
      text: text,
      meaning: (assist && assist.meaning) || "",
      pronunciation: (assist && assist.pronunciation) || "",
      pronunciations: (assist && assist.pronunciations) || {}
    };
  }

  function textMatchesLanguage(language, value) {
  ...
  function filterItemsForLanguage(items, language) {
    return (items || []).filter(function (item) {
      return textMatchesLanguage(language, courseItemText(item));
    });
  }

  function buildCourseItems() {
    var active = activeCourseDay();
    var day = active.day || {};
    var nativeDay = active.nativeDay || {};
    var words = filterItemsForLanguage(day.words || [], active.language);
    var sentences = filterItemsForLanguage(day.sentences || [], active.language);
    var longs = filterItemsForLanguage(day.longs || [], active.language);
    var items = [];
    words.forEach(function (item, index) {
      var next = makeCourseItem("word", item, index, nativeDay.words || [], active);
      if (next) {
        items.push(next);
      }
    });
    sentences.forEach(function (item, index) {
      var next = makeCourseItem("short", item, index, nativeDay.sentences || [], active);
      if (next) {
        items.push(next);
      }
    });
    if (Array.isArray(day.longs)) {
      longs.forEach(function (item, index) {
        var next = makeCourseItem("long", item, index, nativeDay.longs || [], active);
        if (next) {
          items.push(next);
        }
      });
    } else if (sentences.length > 1) {
      var longText = sentences.map(courseItemText).filter(Boolean).join("\n");
      var nativeLongText = ((nativeDay.sentences || []).map(courseItemText).filter(Boolean).join("\n"));
      if (longText) {
        var longAssist = courseItemAssist({ text: longText }, 0, nativeLongText ? [{ text: nativeLongText }] : [], active);
        items.push({
          kind: "long",
          text: longText,
          meaning: (longAssist && longAssist.meaning) || (nativeLongText && nativeLongText !== longText ? nativeLongText : ""),
          pronunciation: (longAssist && longAssist.pronunciation) || "",
          pronunciations: (longAssist && longAssist.pronunciations) || {}
        });
      }
    }
    if (!items.length) {
      courseLettersFromWords(words.length ? words : practiceData().words).slice(0, 5).forEach(function (letter) {
        items.push({ kind: "word", text: letter, meaning: "", pronunciation: "" });
      });
    }
    return items;
  }

  function currentCourseItem() {
    return state.course.items[state.course.index] || null;
  }

  function buildCourseTarget() {
    state.course.items = buildCourseItems();
    state.course.index = 0;
    state.course.completeCount = 0;
    var item = currentCourseItem();
    state.units = item ? [item.text] : [];
    elements.prompt.classList.toggle("is-long", item && item.kind === "long");
  ...
  function updateCoursePractice() {
    var typed = currentTypedValue();
    renderPrompt(typed);
    var metrics = getCourseMetrics(typed);
    updateStats(metrics);
    highlightTargetKey(typed);

    if (!state.composing && typed === state.target) {
      completeCourseItem(metrics);
    }
  }
  ...
  function courseKindLabel(kind) {
    var copy = locale();
    if (kind === "long") {
      return copy.courseKindLong || copy.modes.sentenceLong;
    }
    if (kind === "short") {
      return copy.courseKindShort || copy.modes.sentenceShort;
    }
    return copy.courseKindWord || copy.modes.word;
  }

  function getCourseMetrics(typed) {
    var item = currentCourseItem();
    ...
    var itemProgress = targetChars.length ? Math.min(typedChars.length / targetChars.length, 1) : 0;
    var total = Math.max(state.course.items.length, 1);
    var progress = Math.min(100, ((state.course.completeCount + itemProgress) / total) * 100);
    var accuracy = typedChars.length ? Math.round((correct / typedChars.length) * 100) : 100;
    return {
      correct: correct,
      mistakes: Math.max(typedChars.length - correct, 0),
      elapsedSeconds: 0,
      accuracy: accuracy,
      cpm: 0,
      wpm: 0,
      progress: progress,
      score: state.course.completeCount,
      courseKind: item ? item.kind : "word",
      matched: !!typed && typed === state.target
    };
  }

  function updateCourseStats(metrics) {
    var copy = locale();
    var total = state.course.items.length || 0;
    var displayIndex = total ? Math.min(state.course.index + 1, total) : 0;
    elements.timeLabel.textContent = copy.courseStepLabel || "Step";
    elements.time.textContent = displayIndex + "/" + total;
    elements.accuracyLabel.textContent = copy.courseInputLabel || "Input";
    elements.accuracy.textContent = metrics.matched ? (copy.courseMatched || "Checked") : (copy.courseReady || "Typing");
    elements.cpm.textContent = courseKindLabel(metrics.courseKind);
    elements.speedLabel.textContent = copy.courseKindLabel || "Type";
    elements.mistakeLabel.textContent = copy.courseRemainingLabel || "Left";
    elements.mistakes.textContent = String(Math.max(total - state.course.completeCount, 0));
    elements.progress.style.width = (metrics.progress || 0).toFixed(1) + "%";
  }

  function ensureCourseAssistPanel() {
    if (elements.courseAssistPanel) {
      return elements.courseAssistPanel;
    }
    var panel = document.createElement("aside");
    panel.className = "course-assist-panel";
    panel.setAttribute("aria-live", "polite");
    elements.prompt.insertAdjacentElement("afterend", panel);
    elements.courseAssistPanel = panel;
    return panel;
  }

  function hideCourseAssist() {
    if (elements.courseAssistPanel) {
      elements.courseAssistPanel.hidden = true;
    }
  }
  ...
  function appendCourseAssistRow(root, label, value) {
    ...
    row.className = "course-assist-row";
    var labelNode = document.createElement("span");
    labelNode.className = "course-assist-label";
    labelNode.textContent = label;
    var valueNode = document.createElement("span");
    valueNode.className = "course-assist-value";
  ...
  function appendCoursePronunciationChip(row, label, value) {
    if (!value) {
      return false;
    }
    var chip = document.createElement("span");
    chip.className = "course-pronunciation-chip";
    var labelNode = document.createElement("span");
    labelNode.className = "course-pronunciation-label";
    labelNode.textContent = label;
    var valueNode = document.createElement("span");
    valueNode.className = "course-pronunciation-value";
    valueNode.textContent = value;
  ...
  function courseNativePronunciationLabel(copy) {
    if (copy.coursePronunciationNativeLabel) {
      return copy.coursePronunciationNativeLabel;
    }
    var names = copy.languageNames || {};
    var nativeName = names[state.uiLanguage] || state.uiLanguage || "";
    return nativeName ? nativeName + " guide" : "Guide";
  }

  function appendCoursePronunciationRows(panel, copy, item) {
    var pronunciations = item && item.pronunciations && typeof item.pronunciations === "object" ? item.pronunciations : {};
    var count = 0;
    var row = document.createElement("span");
    row.className = "course-pronunciation-row";
    if (appendCoursePronunciationChip(row, copy.coursePronunciationIpaLabel || "IPA", pronunciations.ipa)) {
      count += 1;
    }
    if (appendCoursePronunciationChip(row, copy.coursePronunciationRomanLabel || "Latin", pronunciations.romanization)) {
      count += 1;
    }
    if (appendCoursePronunciationChip(row, courseNativePronunciationLabel(copy), pronunciations.native)) {
      count += 1;
    }
    if (!count && item && item.pronunciation) {
      appendCoursePronunciationChip(row, copy.coursePronunciationLabel || "Pronunciation", item.pronunciation);
      count += 1;
    }
    if (count) {
  ...
  function renderCourseAssist(done) {
    if (state.mode !== "course") {
      hideCourseAssist();
      return;
    }
    var copy = locale();
    var item = currentCourseItem();
    var panel = ensureCourseAssistPanel();
    panel.hidden = false;
    panel.replaceChildren();
    var title = document.createElement("strong");
    title.className = "course-assist-title";
    title.textContent = done ? (copy.courseCompleteTitle || "Course complete") : courseKindLabel(item && item.kind);
    panel.appendChild(title);
    if (done) {
      var hint = document.createElement("span");
      hint.className = "course-assist-empty";
      hint.textContent = copy.courseCompleteHint || "";
    ...
    appendCourseAssistRow(panel, copy.courseMeaningLabel || "Meaning", item.meaning);
    var pronunciationCount = appendCoursePronunciationRows(panel, copy, item);
    if (!item.meaning && !pronunciationCount) {
      var empty = document.createElement("span");
      empty.className = "course-assist-empty";
      empty.textContent = copy.courseNoAssist || "";
      panel.appendChild(empty);
    }
  }

  function completeCourseItem(metrics) {
    if (state.finished || state.course.advanceTimer) {
      return;
    }
    state.course.completeCount = Math.max(state.course.completeCount, state.course.index + 1);
    elements.input.disabled = true;
    updateStats(Object.assign({}, metrics, { matched: true, progress: (state.course.completeCount / Math.max(state.course.items.length, 1)) * 100 }));
    if (state.course.index >= state.course.items.length - 1) {
      finishCoursePractice();
      return;
    }
    state.course.advanceTimer = window.setTimeout(function () {
      state.course.advanceTimer = 0;
      state.course.index += 1;
      var item = currentCourseItem();
      state.target = item ? item.text : "";
      state.units = item ? [item.text] : [];
      elements.input.value = "";
      elements.input.disabled = false;
      elements.prompt.classList.toggle("is-long", item && item.kind === "long");
  ...
  function finishCoursePractice() {
    state.finished = true;
    state.score = state.course.completeCount;
    state.course.completedAbsolute = courseAbsoluteStep(courseSummary(), state.course.selectedOffset);
    elements.input.disabled = true;
    renderCourseAssist(true);
    saveCourseResult();
    renderHistory();
    showResult({ accuracy: 100, cpm: 0, wpm: 0, elapsedSeconds: 0, score: state.course.completeCount }, {
      title: locale().courseCompleteTitle,
      hint: locale().courseCompleteHint,
      hideMetrics: true
    });
    showHistoryPopup();
    updateNextPreview("");
  ...
  function updateNextPreview(typed) {
    ...
    var nextUnit = "";
    if (state.mode === "course") {
      var nextItem = state.course.items[state.course.index + 1];
      elements.nextPreview.textContent = nextItem ? nextItem.text : "";
      return;
    }
  ...
  function showResult(metrics, options) {
    options = options || {};
    var copy = locale();
    elements.resultKicker.textContent = options.kicker || copy.resultKicker;
    elements.resultTitle.textContent = options.title || copy.resultTitle;
    ...
    if (elements.resultGrid) {
      elements.resultGrid.hidden = !!options.hideMetrics;
    }
    renderCompletionHint(options.hint || "");
    renderCompletionActions();
    elements.resultPanel.hidden = false;
  }

  function renderCompletionHint(text) {
    var hint = ensureCompletionHint();
    if (!text) {
      hint.hidden = true;
      hint.textContent = "";
      return;
  ...
  function ensureCompletionHint() {
    if (elements.completionHint) {
      return elements.completionHint;
    }
    var hint = document.createElement("p");
    hint.className = "completion-hint";
    if (elements.resultGrid && elements.resultGrid.parentNode) {
      elements.resultGrid.parentNode.insertBefore(hint, elements.resultGrid);
    } else {
      elements.resultPanel.appendChild(hint);
    }
    elements.completionHint = hint;
    return hint;
  }

  function renderCompletionActions() {
    var actions = ensureCompletionActions();
    ...
    var copy = locale();
    if (state.mode === "course") {
      if (hasNextCourseStage()) {
        appendCompletionAction(actions, copy.completionNextCourse || "Start Next Stage", true, continueToNextCourseStage);
        appendCompletionAction(actions, copy.completionCourseMap || "View Course Map", false, showCourseMapFromCompletion);
        return;
      }
      appendCompletionAction(actions, copy.completionCourseMap || "View Course Map", true, showCourseMapFromCompletion);
      return;
    }
    appendCompletionAction(actions, copy.completionNextPractice || copy.restart || "Start Next Practice", true, startNextPracticeFromCompletion);
  }

  function ensureCompletionActions() {
    if (elements.completionActions) {
      return elements.completionActions;
    }
    var actions = document.createElement("div");
    actions.className = "course-map-actions completion-actions";
    actions.style.marginTop = "1rem";
    elements.resultPanel.appendChild(actions);
    elements.completionActions = actions;
    return actions;
  }

  function appendCompletionAction(root, label, active, handler) {
    var button = document.createElement("button");
    button.type = "button";
    button.className = "site-menu-action" + (active ? " is-active" : "");
    button.textContent = label;
    button.addEventListener("click", handler);
    root.appendChild(button);
  }

  function primaryCompletionAction() {
    if (!state.finished || !elements.completionPopup || elements.completionPopup.hidden || !elements.completionActions || elements.completionActions.hidden) {
      return null;
    }
    return elements.completionActions.querySelector(".site-menu-action.is-active:not([disabled])") ||
      elements.completionActions.querySelector(".site-menu-action:not([disabled])");
  }

  function activatePrimaryCompletionAction() {
    var button = primaryCompletionAction();
    if (!button) {
      return false;
    }
    button.click();
  ...
  function startNextPracticeFromCompletion() {
    resetPractice();
  }

  function completedCourseAbsoluteStep() {
    if (Number.isFinite(Number(state.course.completedAbsolute))) {
      return Number(state.course.completedAbsolute);
    }
    return courseAbsoluteStep(courseSummary(), state.course.selectedOffset);
  }

  function hasNextCourseStage() {
    return completedCourseAbsoluteStep() < courseMaxAbsoluteStep();
  }

  function continueToNextCourseStage() {
    var max = courseMaxAbsoluteStep();
    var next = Math.min(max, completedCourseAbsoluteStep() + 1);
    setCourseSelectedAbsolute(next);
    state.course.introVisible = false;
    startCoursePractice();
  }

  function showCourseMapFromCompletion() {
    state.course.introVisible = true;
    resetPractice();
  }
  ...
  function hideCompletionPopup() {
    ...
    if (elements.completionHint) {
      elements.completionHint.hidden = true;
  ...
  function saveResult(metrics) {
    var resultLanguage = activePracticeLanguageKey();
    var result = {
      mode: state.mode,
      game: state.mode === "game" ? state.game : "",
      activityKey: currentActivityKey(),
      activityDetailKey: currentActivityDetailKey(),
      languagePairKey: currentLanguagePairKey(),
      activityType: state.mode === "game" ? "game" : "practice",
      uiLanguage: state.uiLanguage,
      nativeLanguage: state.uiLanguage,
      practiceLanguage: resultLanguage,
    ...
    if (window.MirtypeLearningStore && typeof window.MirtypeLearningStore.saveResult === "function") {
      window.MirtypeLearningStore.saveResult(result);
      return;
    }
    var results = readResults();
    results.unshift(result);
    writeResults(limitResultsForScope(results, result, 10));
    refreshShellProgress();
  }
  ...
  function clearHistory() {
    if (window.MirtypeLearningStore && typeof window.MirtypeLearningStore.clearScopedResults === "function") {
      window.MirtypeLearningStore.clearScopedResults({
        pairKey: currentLanguagePairKey(),
        activityKey: currentActivityKey()
      });
      renderHistory();
    ...
    var pairKey = currentLanguagePairKey();
    var activityKey = currentActivityKey();
    writeResults(readResults().filter(function (result) {
      return resultLanguagePairKey(result) !== pairKey || resultActivityKey(result) !== activityKey;
    }));
    renderHistory();
    refreshShellProgress();
  }
  ...
  function readResults() {
    if (window.MirtypeLearningStore && typeof window.MirtypeLearningStore.scopedResults === "function") {
      var remoteResults = window.MirtypeLearningStore.scopedResults({
        pairKey: currentLanguagePairKey(),
        activityKey: currentActivityKey()
      });
  ...
  function setupRain() {
    state.gameState = { tokens: [], spawn: 0, last: Date.now(), pool: gameWordPool() };
  }

  function setupInvader() {
    var count = Math.min(36, 12 + clampGameDifficulty(state.gameDifficulty) * 2);
    var words = gameSample(count);
    state.gameState = { words: words, total: words.length, x: 0, y: 0, dir: 1, step: 0 };
  }

  function setupMining() {
    var count = Math.min(34, 12 + clampGameDifficulty(state.gameDifficulty) * 2);
    var words = gameSample(count);
  ...
  function tickRain() {
    ...
    var difficulty = clampGameDifficulty(state.gameDifficulty);
    var spawnEvery = Math.max(4, 11 - Math.floor(difficulty * 0.7));
    var maxTokens = Math.max(5, 7 + difficulty);
    gs.spawn += 1;
    if (gs.spawn % spawnEvery === 0 && gs.tokens.length < maxTokens) {
      gs.tokens.push({
        text: sample(gs.pool && gs.pool.length ? gs.pool : gameWordPool(), 1)[0],
        x: Math.floor(Math.random() * 78),
        y: -8,
        speed: 0.75 + difficulty * 0.14 + Math.random() * (0.7 + difficulty * 0.11) + state.score * (0.012 + difficulty * 0.0015),
        special: difficulty > 1 && Math.random() < 0.12
      });
    }
  ...
  function tickInvader() {
    ...
    gs.step += 1;
    if (gs.step % 3 === 0) {
      gs.x += gs.dir * (1.4 + difficulty * 0.28);
      if (gs.x > 18 || gs.x < -18) {
        gs.dir *= -1;
        gs.y += 3.8 + difficulty * 0.55;
      }
    }
    if (gs.y > 58) {
      state.misses = 10;
  ...
  function tickMining() {
    ...
    var difficulty = clampGameDifficulty(state.gameDifficulty);
    gs.step += 1;
    if (gs.step % Math.max(5, Math.round(28 - difficulty * 1.8 - Math.floor(state.score / 3))) === 0 && gs.words.length) {
  ...
  function renderKeyboard() {
    var labels = languageKeyLabels[keyboardLanguageKey()] || languageKeyLabels.ko;
  ...
  function handleKeyDown(event) {
    if ((event.key === "Enter" || event.code === "Enter" || event.code === "NumpadEnter") && activatePrimaryCompletionAction()) {
      event.preventDefault();
      event.stopPropagation();
      return;
    }
  ...
  function buildContent() {
    var workbookWords = russianWorkbookWords();
    var koWords = unique([
    ...
    var studyWords = {
      ko: unique([
        "날짜", "요일", "월요일", "화요일", "수요일", "목요일", "금요일", "토요일", "일요일", "날씨", "비", "눈", "바람", "맑음",
        "나", "너", "우리", "이것", "저것", "여기", "거기", "행복", "슬픔", "화남", "걱정", "기쁨", "가족", "부모", "엄마", "아빠", "형제", "자매",
        "하나", "둘", "셋", "넷", "다섯", "안녕하세요", "감사합니다", "죄송합니다", "어디", "언제", "누구", "무엇", "왜", "어떻게",
        "집", "학교", "식당", "가게", "주문", "메뉴", "물", "차", "커피", "가격", "청소", "설거지", "세탁", "요리",
        "보다", "듣다", "냄새", "맛", "만지다", "축구", "농구", "수영", "휴일", "설날", "추석", "지역", "도시", "모스크바"
      ]),
      en: unique([
        "date", "weekday", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday", "sunday", "weather", "rain", "snow", "wind", "sunny",
        "I", "you", "we", "this", "that", "here", "there", "happy", "sad", "angry", "worried", "glad", "family", "parents", "mother", "father", "brother", "sister",
        "one", "two", "three", "four", "five", "hello", "thanks", "sorry", "where", "when", "who", "what", "why", "how",
        "home", "school", "restaurant", "shop", "order", "menu", "water", "tea", "coffee", "price", "cleaning", "dishes", "laundry", "cooking",
        "see", "hear", "smell", "taste", "touch", "football", "basketball", "swimming", "holiday", "newyear", "region", "city", "moscow"
      ]),
      ru: unique([
        "дата", "день", "понедельник", "вторник", "среда", "четверг", "пятница", "суббота", "воскресенье", "погода", "дождь", "снег", "ветер", "ясно",
        "я", "ты", "мы", "это", "то", "здесь", "там", "счастье", "грусть", "злость", "тревога", "радость", "семья", "родители", "мама", "папа", "брат", "сестра",
        "один", "два", "три", "четыре", "пять", "здравствуйте", "спасибо", "извините", "где", "когда", "кто", "что", "почему", "как",
        "дом", "школа", "ресторан", "магазин", "заказ", "меню", "вода", "чай", "кофе", "цена", "уборка", "посуда", "стирка", "готовка",
        "видеть", "слышать", "запах", "вкус", "трогать", "футбол", "баскетбол", "плавание", "праздник", "регион", "город", "москва"
      ])
    };

    var studyShorts = {
      ko: unique([
        "오늘은 월요일입니다.", "내일 날씨는 맑습니다.", "나는 이것을 좋아합니다.", "우리 가족은 집에 있습니다.", "물 한 잔 주세요.",
        "메뉴를 천천히 봅니다.", "이 가게는 어디에 있나요?", "나는 기쁠 때 크게 웃습니다.", "슬플 때는 조용히 쉽니다.", "청소는 아침에 합니다.",
        "설거지는 저녁에 합니다.", "축구는 빠른 반응이 필요합니다.", "맛을 보고 천천히 말합니다.", "소리를 듣고 단어를 떠올립니다.",
        "날씨가 추우면 따뜻한 차를 마십니다.", "식당에서는 먼저 인사하고 주문합니다.", "요일과 월을 알면 약속을 잡기 쉽습니다.",
        "대명사는 짧지만 문장의 방향을 정합니다.", "감정 단어를 익히면 마음을 더 정확히 말할 수 있습니다.", "장소 표현은 길을 묻고 설명할 때 도움이 됩니다."
      ]),
      en: unique([
        "Today is Monday.", "The weather is sunny tomorrow.", "I like this.", "My family is at home.", "A glass of water, please.",
        "I read the menu slowly.", "Where is this shop?", "I smile when I am glad.", "I rest quietly when I am sad.", "I clean in the morning.",
        "I wash the dishes in the evening.", "Football needs a quick reaction.", "I taste it and speak slowly.", "I hear the sound and remember the word.",
        "When the weather is cold, I drink warm tea.", "At a restaurant, I greet first and then order.", "Weekdays and months make appointments easier.",
        "Pronouns are short, but they guide the sentence.", "Emotion words help me say my feelings more clearly.", "Place expressions help when I ask for directions."
      ]),
      ru: unique([
        "Сегодня понедельник.", "Завтра ясная погода.", "Мне это нравится.", "Моя семья дома.", "Стакан воды, пожалуйста.",
        "Я медленно читаю меню.", "Где находится этот магазин?", "Я улыбаюсь, когда мне радостно.", "Когда мне грустно, я отдыхаю тихо.", "Уборку я делаю утром.",
        "Посуду я мою вечером.", "Футбол требует быстрой реакции.", "Я пробую вкус и говорю медленно.", "Я слышу звук и вспоминаю слово.",
        "Когда холодно, я пью теплый чай.", "В ресторане я сначала здороваюсь, потом делаю заказ.", "Дни недели и месяцы помогают назначать встречи.",
        "Местоимения короткие, но задают направление фразы.", "Слова эмоций помогают точнее говорить о себе.", "Выражения места помогают спрашивать дорогу."
      ])
    };

    var studyLongs = {
      ko: unique([
        "날짜와 날씨 표현은 매일 쓰는 가장 작은 언어 단위입니다.\n오늘이 무슨 요일인지 말하고, 비가 오는지 맑은지 말하면 하루의 시작을 설명할 수 있습니다.\n짧은 문장을 정확히 입력하면서 월, 요일, 날씨 단어를 천천히 익힙니다.",
        "가족과 감정 단어는 자기소개에서 자주 만납니다.\n엄마, 아빠, 형제, 자매를 말하고 기쁨, 슬픔, 걱정을 붙이면 문장이 조금 더 사람다워집니다.\n한 문장씩 입력한 뒤에는 같은 주제를 여러 줄로 이어 보며 리듬을 길게 가져갑니다.",
        "식당과 가게 표현은 실제 상황을 떠올리기 쉽습니다.\n먼저 인사하고, 메뉴를 보고, 물이나 차를 부탁하고, 가격을 확인합니다.\n이 흐름은 단어를 외우는 연습을 넘어 실제로 말할 순서를 손끝으로 익히게 합니다."
      ]),
      en: unique([
        "Dates and weather are small language units we use every day.\nWhen you can say the weekday and describe rain, snow, wind, or sun, you can explain the start of a day.\nTyping these short lines slowly helps the words become familiar before the sentences become longer.",
        "Family and emotion words appear often in simple introductions.\nMother, father, brother, sister, happiness, sadness, and worry make a sentence feel closer to real life.\nAfter finishing one short sentence, connect the same topic across several lines and keep the rhythm steady.",
        "Restaurant and shop expressions are easy to imagine in a real situation.\nYou greet someone, read the menu, ask for water or tea, and check the price.\nThis flow turns vocabulary practice into an order of actions that your fingers can remember."
      ]),
      ru: unique([
        "Дата и погода - маленькие выражения, которые нужны каждый день.\nЕсли вы можете назвать день недели и сказать, идет дождь или светит солнце, вы уже описываете начало дня.\nМедленный ввод таких строк помогает словам стать привычными до длинных фраз.",
        "Семья и эмоции часто встречаются в простом рассказе о себе.\nМама, папа, брат, сестра, радость, грусть и тревога делают фразу ближе к реальной жизни.\nПосле одной короткой фразы можно соединить тему в несколько строк и сохранить ровный ритм.",
        "Выражения для ресторана и магазина легко представить в настоящей ситуации.\nСначала вы здороваетесь, потом смотрите меню, просите воду или чай и уточняете цену.\nТак словарь превращается в порядок действий, который постепенно запоминают пальцы."
      ])
    };

    var studyTopicWords = {
      ko: unique([
        "오늘", "내일", "모레", "어제", "그저께", "아침", "낮", "저녁", "밤", "지금", "나중에", "곧",
        "1월", "2월", "3월", "4월", "5월", "6월", "7월", "8월", "9월", "10월", "11월", "12월",
        "태양", "햇빛", "구름", "안개", "강추위", "덥다", "춥다", "따뜻하다", "선선하다", "바람이 분다", "비가 온다", "눈이 온다",
        "나", "너", "그", "그녀", "그것", "우리", "당신들", "그들", "나의", "너의", "우리의", "그들의", "이것", "저것", "이들", "저들",
        "누구", "무엇", "어디", "언제", "왜", "어떻게", "얼마", "어느", "누구의", "어디에서",
        "책상 위", "집 안", "문 밖", "친구와 함께", "의사에게", "엄마에게서", "나를 위해", "러시아에 대해", "나무 뒤", "집 앞",
        "사이에", "아래에", "위에", "통해서", "없이", "만날 때", "공원 근처", "지하철 옆", "주위에", "가운데", "반대하여", "점심 후", "내일까지",
        "안녕하세요", "안녕", "어떻게 지내세요", "오랜만이에요", "만나서 반가워요", "처음 뵙겠습니다", "악수", "포옹", "미소", "눈맞춤",
        "기쁨", "슬픔", "화남", "두려움", "놀람", "부끄러움", "자랑스러움", "차분함", "외로움", "따뜻한 마음",
        "할머니", "할아버지", "남편", "아내", "아들", "딸", "삼촌", "이모", "사촌", "친척",
        "영", "열", "스무", "서른", "백", "천", "첫째", "둘째", "셋째", "하나만", "조금만",
        "똑똑", "째깍째깍", "야옹", "멍멍", "반짝반짝", "쿵", "톡톡", "살금살금",
        "축구", "농구", "배구", "테니스", "하키", "스키", "스케이트", "체스", "달리기", "수영",
        "새해", "크리스마스", "여성의 날", "승리의 날", "부활절", "명절", "기념일", "축하",
        "청소하다", "청소기 돌리다", "바닥을 닦다", "먼지를 털다", "침대를 정리하다", "창문을 닦다", "화장실을 청소하다", "욕실을 청소하다", "장보다", "정리정돈하다",
        "요리하다", "아침을 만들다", "점심을 만들다", "저녁을 만들다", "채소를 자르다", "설거지하다", "빨래하다", "다림질하다", "쓰레기를 버리다",
        "모스크바", "상트페테르부르크", "시베리아", "우랄", "볼가", "바이칼", "크렘린", "붉은 광장", "지하철", "시장",
        "메뉴", "추천 메뉴", "이것 주세요", "이걸 주문할게요", "포장", "여기서 먹을게요", "계산서", "카드로", "현금으로", "영수증", "비싸네요", "천천히 말해주세요",
        "보다", "바라보다", "들다", "들리다", "냄새 맡다", "냄새", "맛보다", "맛", "만지다", "느끼다", "달다", "쓰다", "시다", "짜다", "맵다", "부드럽다", "딱딱하다", "거칠다"
      ]),
      en: unique([
        "today", "tomorrow", "the day after tomorrow", "yesterday", "the day before yesterday", "morning", "daytime", "evening", "night", "now", "later", "soon",
        "january", "february", "march", "april", "may", "june", "july", "august", "september", "october", "november", "december",
        "sun", "sunlight", "cloud", "fog", "frost", "hot", "cold", "warm", "cool", "windy", "rainy", "snowy",
        "I", "you", "he", "she", "it", "we", "you all", "they", "my", "your", "our", "their", "this", "that", "these", "those",
        "who", "what", "where", "when", "why", "how", "how much", "which", "whose", "from where",
        "on the table", "in the house", "out of the door", "with a friend", "to the doctor", "from mother", "for me", "about Russia", "behind the tree", "in front of the house",
        "between", "under", "above", "through", "without", "during a meeting", "near the park", "next to the metro", "around", "among", "against", "after lunch", "until tomorrow",
        "hello", "hi", "how are you", "long time no see", "glad to see you", "nice to meet you", "handshake", "hug", "smile", "eye contact",
        "joy", "sadness", "anger", "fear", "surprise", "shame", "pride", "calm", "loneliness", "warm heart",
        "grandmother", "grandfather", "husband", "wife", "son", "daughter", "uncle", "aunt", "cousin", "relative",
        "zero", "ten", "twenty", "thirty", "hundred", "thousand", "first", "second", "third", "only one", "a little",
        "knock knock", "tick tock", "meow", "woof", "sparkle", "thud", "tap tap", "quietly",
        "football", "basketball", "volleyball", "tennis", "hockey", "skiing", "skating", "chess", "running", "swimming",
        "New Year", "Christmas", "Women's Day", "Victory Day", "Easter", "holiday", "anniversary", "celebration",
        "clean", "vacuum", "mop the floor", "dust", "make the bed", "wash the windows", "clean the toilet", "clean the bathroom", "go shopping", "tidy up",
        "cook", "make breakfast", "make lunch", "make dinner", "cut vegetables", "wash dishes", "do laundry", "iron", "take out trash",
        "Moscow", "Saint Petersburg", "Siberia", "Ural", "Volga", "Baikal", "Kremlin", "Red Square", "metro", "market",
        "menu", "recommendation", "this please", "I will order this", "to go", "I will eat here", "bill", "by card", "in cash", "receipt", "expensive", "please speak slowly",
        "see", "look", "hear", "listen", "smell", "odor", "taste", "flavor", "touch", "feel", "sweet", "bitter", "sour", "salty", "spicy", "soft", "hard", "rough"
      ]),
      ru: unique([
        "сегодня", "завтра", "послезавтра", "вчера", "позавчера", "утром", "днем", "вечером", "ночью", "сейчас", "потом", "скоро",
        "январь", "февраль", "март", "апрель", "май", "июнь", "июль", "август", "сентябрь", "октябрь", "ноябрь", "декабрь",
        "солнце", "свет", "облако", "туман", "мороз", "жарко", "холодно", "тепло", "прохладно", "ветрено", "дождливо", "снежно",
        "я", "ты", "он", "она", "оно", "мы", "вы", "они", "мой", "твой", "наш", "их", "это", "тот", "эти", "те",
        "кто", "что", "где", "когда", "почему", "как", "сколько", "какой", "чей", "откуда",
        "на столе", "в доме", "из двери", "с другом", "к врачу", "от мамы", "для меня", "о России", "за деревом", "перед домом",
        "между", "под", "над", "через", "без", "при встрече", "около парка", "возле метро", "вокруг", "среди", "против", "после обеда", "до завтра",
        "здравствуйте", "привет", "как дела", "давно не виделись", "рад тебя видеть", "очень приятно", "рукопожатие", "объятие", "улыбка", "зрительный контакт",
        "радость", "грусть", "злость", "страх", "удивление", "стыд", "гордость", "спокойствие", "одиночество", "теплое сердце",
        "бабушка", "дедушка", "муж", "жена", "сын", "дочь", "дядя", "тетя", "двоюродный брат", "родственник",
        "ноль", "десять", "двадцать", "тридцать", "сто", "тысяча", "первый", "второй", "третий", "только один", "немного",
        "тук-тук", "тик-так", "мяу", "гав-гав", "блестеть", "бух", "тук-тук", "тихо",
        "футбол", "баскетбол", "волейбол", "теннис", "хоккей", "лыжи", "коньки", "шахматы", "бег", "плавание",
        "Новый год", "Рождество", "Женский день", "День Победы", "Пасха", "праздник", "годовщина", "поздравление",
        "убирать", "пылесосить", "мыть пол", "вытирать пыль", "заправлять кровать", "мыть окна", "чистить туалет", "убирать ванную", "ходить за покупками", "наводить порядок",
        "готовить", "готовить завтрак", "готовить обед", "готовить ужин", "резать овощи", "мыть посуду", "стирать", "гладить", "выбрасывать мусор",
        "Москва", "Санкт-Петербург", "Сибирь", "Урал", "Волга", "Байкал", "Кремль", "Красная площадь", "метро", "рынок",
        "меню", "рекомендация", "мне это пожалуйста", "я закажу это", "с собой", "здесь пожалуйста", "счет", "картой", "наличными", "чек", "дорого", "говорите медленнее",
        "видеть", "смотреть", "слушать", "слышать", "нюхать", "запах", "пробовать", "вкус", "трогать", "чувствовать", "сладкий", "горький", "кислый", "соленый", "острый", "мягкий", "твердый", "шершавый"
      ])
    };

    var studyTopicShorts = {
      ko: unique([
        "오늘은 화요일이고 날씨가 맑습니다.", "내일은 비가 오고 바람이 불겠습니다.", "지금은 5월이고 저녁에는 선선합니다.",
        "나는 이 책을 책상 위에 둡니다.", "저 사람은 내 친구입니다.", "이것은 내 가방이고 저것은 네 가방입니다.", "이 사람들은 우리 가족입니다.",
        "누구세요?", "이게 뭐예요?", "어디에서 왔어요?", "왜 늦었나요?", "얼마예요?", "어느 길로 가나요?",
        "나는 집 안에 있습니다.", "책은 책상 위에 있습니다.", "고양이는 탁자 아래에 있습니다.", "가게는 지하철 옆에 있습니다.", "점심 후에 만나요.",
        "안녕하세요, 처음 뵙겠습니다.", "오랜만이에요.", "만나서 반가워요.", "친구에게는 미소와 함께 인사합니다.", "문턱에서 악수하지 않습니다.",
        "나는 오늘 기쁩니다.", "그는 조금 걱정합니다.", "슬플 때는 천천히 쉽니다.", "마음을 열면 표정이 따뜻해집니다.",
        "우리 할머니는 차를 좋아합니다.", "내 동생은 축구를 합니다.", "사촌은 주말에 우리 집에 옵니다.",
        "하나만 주세요.", "조금만 주세요.", "영수증 주세요.", "카드로 결제할게요.", "현금으로 계산할게요.",
        "메뉴 좀 주세요.", "이걸 주문할게요.", "여기서 먹을게요.", "포장해 주세요.", "천천히 말씀해 주세요.", "저는 러시아어를 조금만 해요.",
        "나는 아침에 청소합니다.", "저녁에는 설거지를 합니다.", "토요일에는 빨래를 합니다.", "쓰레기를 버리고 방을 정리합니다.", "오늘은 집안일이 많습니다.",
        "잘 보여요.", "여기는 조용합니다.", "좋은 냄새가 납니다.", "이 케이크는 너무 달아요.", "레몬은 시어요.", "얼음은 차갑고 곰 인형은 부드럽습니다.",
        "축구는 빠른 반응이 필요합니다.", "하키 경기는 겨울에 자주 봅니다.", "새해에는 가족에게 인사합니다.", "모스크바에는 지하철이 많습니다.", "바이칼은 아주 큰 호수입니다.",
        "처음에는 표정이 진지해 보여도 인사를 나누면 분위기가 부드러워집니다.", "친구들과 웃으며 말하면 새로운 언어가 덜 무섭습니다."
      ]),
      en: unique([
        "Today is Tuesday and the weather is sunny.", "Tomorrow it will rain and the wind will blow.", "It is May now, and the evening is cool.",
        "I put this book on the table.", "That person is my friend.", "This is my bag and that is your bag.", "These people are my family.",
        "Who are you?", "What is this?", "Where are you from?", "Why are you late?", "How much is it?", "Which way should I go?",
        "I am in the house.", "The book is on the table.", "The cat is under the table.", "The shop is next to the metro.", "See you after lunch.",
        "Hello, nice to meet you.", "Long time no see.", "I am glad to see you.", "Friends greet each other with a smile.", "Do not shake hands across a doorway.",
        "I am happy today.", "He is a little worried.", "When I am sad, I rest slowly.", "When people open their hearts, their faces become warm.",
        "My grandmother likes tea.", "My younger brother plays football.", "My cousin comes to our home on the weekend.",
        "Only one, please.", "A little, please.", "The receipt, please.", "I will pay by card.", "I will pay in cash.",
        "May I have the menu, please?", "I will order this.", "I will eat here.", "To go, please.", "Please speak slowly.", "I speak only a little Russian.",
        "I clean in the morning.", "I wash dishes in the evening.", "I do laundry on Saturday.", "I take out the trash and tidy the room.", "There are many chores today.",
        "I can see well.", "It is quiet here.", "It smells good.", "This cake is too sweet.", "The lemon is sour.", "Ice is cold and the teddy bear is soft.",
        "Football needs a quick reaction.", "I often watch hockey in winter.", "On New Year, I greet my family.", "There are many metro stations in Moscow.", "Baikal is a very large lake.",
        "At first, serious faces can feel cold, but greetings make the air softer.", "When I laugh and speak with friends, a new language feels less scary."
      ]),
      ru: unique([
        "Сегодня вторник, и погода солнечная.", "Завтра будет дождь и ветер.", "Сейчас май, а вечером прохладно.",
        "Я кладу эту книгу на стол.", "Тот человек - мой друг.", "Это моя сумка, а то твоя сумка.", "Эти люди - моя семья.",
        "Кто вы?", "Что это?", "Откуда вы?", "Почему вы опоздали?", "Сколько это стоит?", "Какой дорогой идти?",
        "Я в доме.", "Книга на столе.", "Кот под столом.", "Магазин возле метро.", "Увидимся после обеда.",
        "Здравствуйте, очень приятно.", "Давно не виделись.", "Рад тебя видеть.", "Друзья здороваются с улыбкой.", "Через порог руку не пожимают.",
        "Сегодня мне радостно.", "Он немного волнуется.", "Когда мне грустно, я медленно отдыхаю.", "Когда люди открывают сердце, лицо становится теплым.",
        "Моя бабушка любит чай.", "Мой младший брат играет в футбол.", "Мой двоюродный брат приходит к нам на выходных.",
        "Только один, пожалуйста.", "Немного, пожалуйста.", "Чек, пожалуйста.", "Я заплачу картой.", "Я заплачу наличными.",
        "Можно меню, пожалуйста?", "Я закажу это.", "Я буду есть здесь.", "С собой, пожалуйста.", "Говорите медленнее, пожалуйста.", "Я немного говорю по-русски.",
        "Утром я убираюсь.", "Вечером я мою посуду.", "В субботу я стираю.", "Я выбрасываю мусор и навожу порядок.", "Сегодня много домашних дел.",
        "Хорошо видно.", "Здесь тихо.", "Пахнет хорошо.", "Этот торт слишком сладкий.", "Лимон кислый.", "Лед холодный, а мишка мягкий.",
        "Футбол требует быстрой реакции.", "Зимой я часто смотрю хоккей.", "На Новый год я поздравляю семью.", "В Москве много станций метро.", "Байкал - очень большое озеро.",
        "Сначала серьезные лица могут казаться холодными, но приветствие делает атмосферу мягче.", "Когда я смеюсь и говорю с друзьями, новый язык уже не кажется страшным."
      ])
    };

    var studyTopicLongs = {
      ko: unique([
        "오늘은 화요일이고 날씨는 맑지만 바람이 조금 붑니다.\n아침에는 따뜻한 차를 마시고, 저녁에는 5월의 선선한 공기를 느낍니다.\n날짜와 날씨를 함께 말하면 하루의 시작을 자연스럽게 설명할 수 있습니다.",
        "이것은 내 책이고 저것은 네 가방입니다.\n그 사람은 내 친구이고, 이 사람들은 우리 가족입니다.\n대명사와 지시어를 익히면 짧은 문장에서도 누가 무엇을 말하는지 분명해집니다.",
        "책은 책상 위에 있고 고양이는 탁자 아래에 있습니다.\n가게는 지하철 옆에 있고 학교는 공원 근처에 있습니다.\n위치 전치사를 연습하면 길을 묻고 장소를 설명하는 문장이 훨씬 쉬워집니다.",
        "식당에 들어가면 먼저 인사하고 메뉴를 부탁합니다.\n이것을 주문하겠다고 말하고, 물이나 차를 부탁한 뒤, 계산할 때 카드나 현금을 선택합니다.\n처음에는 한 문장만 외워도 충분하지만, 상황의 순서를 손끝으로 익히면 실제 대화가 편해집니다.",
        "아침에는 청소기를 돌리고 바닥을 닦습니다.\n저녁에는 설거지를 하고 쓰레기를 버린 뒤 방을 정리합니다.\n집안일 동사는 매일 반복되는 행동이라 짧은 연습을 긴 생활 문장으로 연결하기 좋습니다.",
        "잘 보인다, 잘 들린다, 좋은 냄새가 난다, 너무 달다, 매우 춥다.\n오감 표현은 주변을 설명하는 데 바로 쓰입니다.\n눈, 귀, 코, 입, 손의 순서로 문장을 만들면 단어가 장면과 함께 기억됩니다.",
        "처음 만난 사람의 표정이 진지해 보여도 너무 빨리 판단하지 않습니다.\n인사를 하고 눈을 맞추고 천천히 말하면 분위기가 부드러워집니다.\n마음을 열면 웃음과 따뜻함이 뒤따른다는 작은 이야기도 좋은 언어 연습이 됩니다."
      ]),
      en: unique([
        "Today is Tuesday, and the weather is sunny, but the wind is a little strong.\nIn the morning I drink warm tea, and in the evening I feel the cool air of May.\nWhen I connect dates and weather, I can describe the start of a day naturally.",
        "This is my book, and that is your bag.\nThat person is my friend, and these people are my family.\nPronouns and demonstratives make it clear who is speaking and what the sentence points to.",
        "The book is on the table, and the cat is under the table.\nThe shop is next to the metro, and the school is near the park.\nWhen I practice place prepositions, asking for directions and describing locations becomes much easier.",
        "When I enter a restaurant, I greet first and ask for the menu.\nI say that I will order this, ask for water or tea, and choose card or cash when I pay.\nAt first, one sentence is enough, but learning the order of the situation makes real conversation easier.",
        "In the morning I vacuum and mop the floor.\nIn the evening I wash dishes, take out the trash, and tidy the room.\nChore verbs repeat every day, so they connect short typing practice with longer life sentences.",
        "I can see well, I can hear well, it smells good, it is too sweet, and it is very cold.\nSense expressions are useful as soon as I describe the world around me.\nWhen I build sentences in the order of eyes, ears, nose, mouth, and hands, words stay connected to scenes.",
        "When I meet someone for the first time, a serious face does not always mean a cold heart.\nIf I greet them, keep eye contact, and speak slowly, the air becomes softer.\nA small story about opening the heart can also become good language practice."
      ]),
      ru: unique([
        "Сегодня вторник, погода солнечная, но ветер немного сильный.\nУтром я пью теплый чай, а вечером чувствую прохладный майский воздух.\nКогда я соединяю дату и погоду, я естественно описываю начало дня.",
        "Это моя книга, а то твоя сумка.\nТот человек - мой друг, а эти люди - моя семья.\nМестоимения и указательные слова помогают точно понять, кто говорит и на что указывает фраза.",
        "Книга лежит на столе, а кот сидит под столом.\nМагазин находится возле метро, а школа около парка.\nКогда я тренирую предлоги места, легче спрашивать дорогу и описывать место.",
        "Когда я захожу в ресторан, я сначала здороваюсь и прошу меню.\nЯ говорю, что закажу это, прошу воду или чай, а потом выбираю оплату картой или наличными.\nСначала достаточно одной фразы, но порядок ситуации помогает говорить увереннее.",
        "Утром я пылесошу и мою пол.\nВечером я мою посуду, выбрасываю мусор и навожу порядок в комнате.\nГлаголы домашних дел повторяются каждый день, поэтому короткая тренировка легко становится длинным бытовым текстом.",
        "Хорошо видно, хорошо слышно, пахнет приятно, слишком сладко и очень холодно.\nСлова чувств сразу помогают описывать мир вокруг нас.\nЕсли строить фразы через глаза, уши, нос, рот и руки, слова запоминаются вместе со сценой.",
        "Когда я впервые встречаю людей, серьезное лицо не всегда значит холодное сердце.\nЕсли поздороваться, смотреть в глаза и говорить спокойно, атмосфера становится мягче.\nНебольшая история о том, как люди открывают сердце, тоже становится хорошей языковой практикой."
      ])
    };
    ...
    return {
      ko: {
        ...
        words: unique(koWords.concat(studyWords.ko).concat(studyTopicWords.ko).concat(workbookWords.ko)),
        shorts: unique(studyShorts.ko.concat(studyTopicShorts.ko).concat(makeKoreanShorts())),
        longs: unique(studyLongs.ko.concat(studyTopicLongs.ko).concat(makeKoreanLongs()))
      },
      en: {
        label: "English",
        seat: {
        ...
        words: unique(enWords.concat(studyWords.en).concat(studyTopicWords.en).concat(workbookWords.en)),
        shorts: unique(studyShorts.en.concat(studyTopicShorts.en).concat(makeEnglishShorts())),
        longs: unique(studyLongs.en.concat(studyTopicLongs.en).concat(makeEnglishLongs()))
      },
      ru: {
        label: "Русский",
        seat: {
        ...
        words: unique(ruWords.concat(studyWords.ru).concat(studyTopicWords.ru).concat(workbookWords.ru)),
        shorts: unique(studyShorts.ru.concat(studyTopicShorts.ru).concat(makeRussianShorts())),
        longs: unique(studyLongs.ru.concat(studyTopicLongs.ru).concat(makeRussianLongs()))
      }
    };
  }

  function russianWorkbookWords() {
    return {
      ko: [],
      en: [],
      ru: []
  ...
  function contentList(value, language) {
    ...
    return unique(value.map(function (item) {
      ...
      return item && textMatchesLanguage(language, item);
    }));
  }

  function applyPracticeContentPayload(payload) {
    var languages = payload && payload.languages ? payload.languages : payload;
    if (!languages || typeof languages !== "object") {
      return false;
    }
    var changed = false;
    ["ko", "en", "ru"].forEach(function (language) {
      var external = languages[language];
      var current = data[language];
      if (!external || !current) {
        return;
      }
      var words = contentList(external.words, language);
      var shorts = contentList(external.shorts, language);
      var longs = contentList(external.longs, language);
      if (!words.length && !shorts.length && !longs.length) {
        return;
      }
      data[language] = Object.assign({}, current, {
        words: words.length ? words : current.words,
        shorts: shorts.length ? shorts : current.shorts,
        longs: longs.length ? longs : current.longs
      });
      changed = true;
    });
    if (changed && elements.input && !state.startedAt) {
      resetPractice();
    }
    return changed;
  }
  ...
  window.MirtypePracticeApp = {
    applyContent: applyPracticeContentPayload
  };

  if (window.MirtypePracticeContent) {
    applyPracticeContentPayload(window.MirtypePracticeContent);
  }
}());
