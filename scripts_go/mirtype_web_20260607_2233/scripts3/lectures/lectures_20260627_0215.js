(function () {
  ...
  var locales = {
    ...
    ru: {
      ...
      affiliateNotice: "Некоторые ссылки являются партнерскими и могут поддержать работу MirType.",
  ...
  var inflearnLogo = "https://cdn.jsdelivr.net/gh/statground/Statground_CDN/images/data/lecture/inflearn.svg";
  var adpickLogo = "https://cdn.jsdelivr.net/gh/statground/Statground_CDN/images/common/affiliates/adpick.png";
  ...
  function renderAffiliateCards(item) {
    ...
    notice.appendChild(el("span", "", copy().affiliateNotice));
