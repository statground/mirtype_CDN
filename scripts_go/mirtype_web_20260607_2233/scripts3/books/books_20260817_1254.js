(function () {
  ...
  function load() {
    ...
    // Book visibility is an operational policy boundary. Do not paint a
    // persisted discovery/detail payload before the server has applied the
    // current policy revision, and do not fall back to stale browser content
    // when that check cannot complete.
